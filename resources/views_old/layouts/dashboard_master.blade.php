...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-body-wrapper">
            <!-- Page Sidebar Start-->
            <div class="sidebar-wrapper" data-layout="stroke-svg" {{-- style="background-image: url({{ asset('images/bg2.jpg') }});"> --}}>
                    ...
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            @if (Auth::user()->hasRole('MHI-AS') || Auth::user()->hasRole('MHI-DS') || Auth::user()->hasRole('MHI-OnlyView'))
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                    ...
                                    <ul class="sidebar-submenu" style="display: none;">
                                        ...
                                        <li><a href="{{ route('OEM-Sales-Report') }}">Actual Sales Details</a></li>
                                    </ul>
                                </li>
                            @elseif(Auth::user()->hasRole('OEM'))
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"> </i><a
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li><a href="{{ route('manageBuyerDetails.index', 'A') }}">Approved Customer
                                                Details</a></li>
                                        <li><a href="{{ route('manageBuyerDetails.returnToDealer') }}">Return to
                                                Dealer</a></li>
                                ...
                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav" href="{{ route('uploadSales') }}">
                                        <i class="fa fa-thumb-tack"></i>
                                        <svg class="stroke-icon">
                                            <use href="{{ asset('admin/svg/icon-sprite.svg#stroke-sample-page') }}">
                                            </use>
