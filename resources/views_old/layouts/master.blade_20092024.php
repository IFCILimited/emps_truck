                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="footer-box mb-md-80">
                        ...
                        <ul class="custom links" style="column-count: 2;">
                            ...
                            <li> <a href="{{ route('Claim_submission') }}" class="text-custom-white">Claim submission</a>
                            </li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-box">
                        <div class="footer-heading mt-60">
                            <h4 class="mt-3 text-center text-custom-white">Portal Designed and Developed By <a href="https://www.ifciltd.com/?q=en/content/what-we-are" target="_blank"> IFCI Ltd.</a></h4>
                        </div>
