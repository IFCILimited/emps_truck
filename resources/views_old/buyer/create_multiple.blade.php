                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4 mb-3" id="">
                                            ...
                                            <input type="text" class="form-control" id="addr" name="cust_addr">
                                        </div>
                                        ...
                                        <div class="col-6 mb-3" id="">
                                            <label class="form-label">Authorized Person Address:</label>
                                            <input type="text" class="form-control readonly" id="ath_per_addr" name="ath_per_addr" readonly>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary" onclick="">Fetch Data</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control readonly" id="vin" name="cat_name[]" readonly/>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <label class="form-label" for="vehicle_segment">xEV Model Name/Code:</label>
                                                                <input class="form-control readonly" id="vin" name="xev_mode_name[]" readonly/>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label class="form-label" for="vehicle_segment">Model Variant (if any):</label>
                                                                <input class="form-control readonly" id="vin" name="model_var[]" readonly/>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <label class="form-label" for="vehicle_segment">Model Segment:</label>
                                                                <input class="form-control readonly" id="vin" name="mode_seg[]" readonly/>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control readonly" id="vin" name="ex_fact[]" readonly/>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <label class="form-label" for="vehicle_segment">Manufacturing Date:</label>
                                                                <input class="form-control readonly" id="vin" name="manu_date[]" readonly/>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <label class="form-label" for="range">Invoice Amount(INR)(per vehicle):</label>
                                                                <input class="form-control" id="range" type="text" value=""
                                                                    name="dlr_invoice_no">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <label class="form-label" for="range">Admissible Incentive Amount(INR)(per vehicle):</label>
                                                                <input class="form-control readonly" id="range" type="text" value=""
                                                                    name="dlr_invoice_no" readonly>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <label class="form-label" for="range">Total Invoice Amount(INR):</label>
                                                                <input class="form-control readonly" id="range" type="text" value=""
                                                                    name="dlr_invoice_no" readonly>
                                                            </div>
                                                        </td>
            ...
            $.ajax({
                ...
                success: function(responce) {
                    ...
                    if (responce.data2 == 1) {
                        ...
                        console.log(manufacturingDate, startDate, endDate)
