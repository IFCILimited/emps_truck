        ...
        <div class="container-fluid">
            <form action="{{ route('buyerdetail.multi_invoice_update') }}" role="form" method="POST"
                                ...
                                <div class="card-body" id="oldVin">
                                    ...
                                    <div class="row">
                                        <div class="col-4 mb-3">
                                            ...
                                            <input class="form-control readonly" id="vin_number" name=""
                                        ...
                                        <div class="col-4 mb-3" id="">
                                            ...
                                            <input class="form-control srchV readonly"
                                                value="{{ date('Y-m-d', strtotime($prodDet->manufacturing_date)) }}" id="manufacturing_date"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-3 mb-3">
                                        ...
                                        <input class="form-control" id="vhcl_reg_file" type="file" name="vhcl_reg_file" @if($bankDetail->vhcl_reg_file) value="{{$bankDetail->vhcl_reg_file}}" @endif>
                                        <input id="vhcl_reg_file_exist" type="hidden" name="vhcl_reg_file_exist" @if($bankDetail->vhcl_reg_file) value="{{$bankDetail->vhcl_reg_file}}" @endif/>
                                    ...
                                    <div class="col-12">
                                        <button type="button" class="btn btn-info text-light" id="fetchDetails">Fetch RC Details</button>
                                        {{-- @if($bankDetail->temp_reg_no || $bankDetail->vhcl_regis_no) --}}
                                            {{-- <div class="" id="e_voucher_div"> --}}
                                                <a style="width: 35%;float: right;" id="e_voucher_div" target="_blank" href="{{ route('dealer.multiBuyerVoucher', encrypt($bankDetail->id)) }}" class="btn btn-success">Generate &
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td>
                                                ...
                                                <input type="hidden" name="cust_ack_exist" value="{{$bankDetail->cst_ack_file}}"/>
                                            ...
                                            <td>
                                                ...
                                                <input class="form-control docs_upload" data-target="invc" id="invoice_copy" type="file"
                                                    name="invc_copy_file">
                                                    <input type="hidden" name="cust_invoice_exist" value="{{$bankDetail->invc_copy_file}}"/>
                                                <br>
                                                <br>
                                            </td>
                                            <td>
                                                ...
                                                <input class="form-control docs_upload" data-target="evoucher" id="e_voucher_copy" type="file"
                                                    ...
                                                    <input type="hidden" name="cust_voucher_exist" value="{{$bankDetail->evoucher_copy_id}}"/>
                                            ...
                                            <td>
                                                ...
                                                <input class="form-control docs_upload" data-target="selfie" id="customer_selfie_copy" type="file"
                                                    ...
                                                    <input type="hidden" name="cust_self_file" value="{{$bankDetail->self_copy_id}}"/>
                                                <br>
                                                <br>
                                            </td>
                                        </tr>
                ...
                <div style="display: flex;justify-content: space-evenly;align-items: center;">
                    ...
                    <div class="text-end">
                        <form id="final_submit_form" action="{{route('buyerdetail.multi_invoice_submit')}}" method="post">
                            @csrf
                            <input type="hidden" name="buyer_row_id" value="{{encrypt($bankDetail->id)}}"/>
                            <input type="hidden" name="row_id" value="{{encrypt($rowId)}}"/>
                            <button id="final_submit_btn" type="submit" class="btn btn-primary form-control-sm mt-2" >Save</button>
                        </form>
                    </div>
                    @endif
            ...
            $.ajax({
                ...
                success: function(responce) {
                    ...
                    if(responce.data4 == true) {
                        ...
                        let dateObject = new Date(dateFetched);
                        let formatedDate = dateObject.toISOString().slice(0, 10);

                        $('#vihcle_dt').val(formatedDate);
                        ...
                        $('#temp_reg').removeAttr("readonly");
                        $('#temp_reg').removeClass("readonly");

                        $('#vhcl_regis_no').removeAttr("readonly");
                        $('#vhcl_regis_no').removeClass("readonly");

                        $('#vihcle_dt').removeAttr("readonly");
                        $('#vihcle_dt').removeClass("readonly");
