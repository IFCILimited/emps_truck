        ...
        <div class="container-fluid">
            <form action="{{ route('buyer.update', $bankDetail->id) }}" role="form" method="POST"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-select customer-type" id="cstm_typ" name="custmr_typ">
                                                <option selected="selected" disabled value="0">Select</option>
                                                    <option value="2"
                                                        @if ($bankDetail->custmr_typ == 1) selected @endif>
                                        ...
                                        <div class="col-md-4 mb-3" id="">
                                            ...
                                            <input type="text" class="form-control" id="custmr_name"
                                                name="authr_per_name" value="{{ $bankDetail->custmr_name }}">
                                        </div>
                                        <div class="col-md-4 mb-3" id="">
                                            <label class="form-label">Authorized Person Name as per <span
                                                style="color: green;">Aadhaar:</span></label>
                                            <input type="text" class="form-control readonly" id="ath_per_name" name="ath_per_name" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
                            ...
                            {{-- <div class="col-sm-12 customer-info">
                                <div class="card height-equal">
                                    <div class="card-header">
                                        <h4>Authorized Person Address Details</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input class="form-control readonly" type="text" id="Landmark"
                                                    name="landmark" value="{{ $bankDetail->landmark }}" readonly>
                                            </div>
                            ...
                            {{-- <div class="card height-equal">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="landmark">Landmark:</label>
                                            <input class="form-control readonly" id="landmark" type="text"
                                                name="landmark" readonly>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label" for="Pincode">Pincode:</label>
                                            <input class="form-control readonly" type="text" name="Pincode"
                                                placeholder="Pincode"
                                                onkeyup="GetCityByPinCode('OEM', this.value, 0)" readonly>
                                            <span id="OEMpincodeMsg0"
                                                style="color:red;font-weight:bold;display: none">
                                                @error('Pincode')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input class="form-control" id="cust_id_sec" type="text"
                                                    value="" name="cust_id_sec readonly">
                                            </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-stripped table-bordered" id="multiVinTable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" class="btn btn-primary">Add Details</a>
                                            </td>
                                            <td>
                                                <a href="javascript:void(0)" class="btn btn-info">Edit Details</a>
                                            </td>
                                            <td>
                                ...
                                <div class="row">
                                    <div class="col-3 mb-3">
                                        ...
                                        <input data-target="temp_reg" type="text"
                                            class="reg_num form-control {{ $bankDetail->temp_reg_no ? 'readonly' : '' }}"
                                    ...
                                    <div class="col-3 mb-3">
                                        ...
                                        <input class="form-control" id="vihcle_dt" type="date"
                                            value="{{ date('d-m-y', strtotime($bankDetail->vihcle_dt)) }}"
                                            onchange="validateDates()" name="vihcle_dt">
                                    </div>
                                    <div class="col-3 mb-3">
                ...
                <div style="display: flex;justify-content: space-evenly;align-items: center;">
                    <div class="text-left">
                        <a href="{{ route('buyerdetail.multi_detail_edit', 195863) }}" class="btn btn-warning">Back</a>
                    </div>
                    <div class="text-center">
                    ...
                    <div class="text-end">
                        <button type="button" class="btn btn-primary form-control-sm mt-2" id="submitBtn">Submit</button>
                    </div>
    ...
    <script>
        ...
        function updateButtonText() {
            ...
            if (regNum.value || regDate.value || regFile.files.length > 0) {
                submitBtn.textContent = "Submit with RC Details"; // Change button text to Submit
                submitBtn.classList.remove('btn-primary'); // Remove the new class
                submitBtn.classList.add('btn-success'); // Reset to original class
            } else {
                submitBtn.textContent = "Submit without RC Details"; // Default button text
        ...
        // Assuming cust_typ is available from the backend, inject it into the JavaScript
        var cust_typ = {{ $bankDetail->custmr_typ }}; // Pass cust_typ from your controller or model

        // Check if cust_typ == 1
        if (cust_typ == 1) {
            // Event listener for Temporary Registration Number input
            // document.getElementById('temp_reg').addEventListener('input', function() {
            //     const tempReg = this.value;
            //     const eVoucherDiv = document.getElementById('e_voucher_div');

            //     // Check if temp_reg has exactly 13 characters
            //     if (tempReg.length === 13) {
            ...
            // document.getElementsByClassName("reg_num").addEventListener('input', function(){
            //     console.log(this.value, this.getAttribute("data-target"));
            // });
            ...
            document.getElementById('e_voucher_btn').addEventListener('click', function() {
                ...
                // if (confirm('Are you sure you want to view the E-Voucher? This will lock the Temporary Registration Number field.')) {
                //     // Set temp_reg field to read-only if user confirms
                //     const tempRegField = document.getElementById('temp_reg');
                //     tempRegField.readOnly = true; // Make input field readonly
                ...
                //     window.open("{{ route('dealer.view_certificate', encrypt($id)) }}", '_blank');
                // }
                let isTempReg = false;
                let isPermReg = false;
                ...
                let tempVal = 0;
                let permVal = 0;
                let buyer_id = {!! json_encode($bankDetail->buyer_id) !!}; // Safely encode the PHP variable
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // const tempRegValue = tempRegField.value;
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (target == "both") {
                                    ...
                                    permRegField.classList.add(
                                    'readonly'); // Add readonly class

                                    tempRegField.readOnly = true;
                                    tempRegField.classList.add(
                                    'readonly'); // Add readonly class
                                } else if (target == "perm") {
                                    permRegField.readOnly = true;
                                    permRegField.classList.add(
                                ...
                                // Set temp_reg field to read-only
                                // tempRegField.readOnly = true;
                                // tempRegField.classList.add('readonly'); // Add readonly class
                                ...
                                // link.href =
                                //     "{{ route('dealer.view_certificate', encrypt($id)) }}"; // File download URL
                                // link.setAttribute('download',
                                // 'E-Voucher.pdf'); // Specify the file name to download
