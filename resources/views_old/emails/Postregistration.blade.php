                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <h2>{{ env('APP_NAME')}} Portal</h2>
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Your post-registration process has been initiated.
                                </h5>
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>You have successfully submitted the details of post-registration for approval under {{ env('APP_NAME')}}-2024 scheme.</p>                                        
                                     <ul>
       
                                       <li>
                                                <p>
                                                   You can now login to the {{ env('APP_NAME')}} portal once approved with username :<br>
