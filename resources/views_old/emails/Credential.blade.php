                                ...
                                <tr>
                                    <td
                                        ...
                                        Please find your login details below:<br>
                                            ...
                                            {{-- <b>Url:</b> <a class="nav-link" href="{{route('password.reset')}}">http://localhost:8000/password/reset</a>  --}}
                                            {{--<b>Url:</b> <a href="{{ URL::to('password/forgot') }}" target="_blank">Reset Password</a>--}}
                                        </p>
                                        <p>
                                            The password is autogenerated.To change your password, click the Forget Password on Login page.
                                        </p>
                                        <p>
                                            Regards<br>
                                            IFCI Ltd.
