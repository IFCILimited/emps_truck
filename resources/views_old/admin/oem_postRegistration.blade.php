   ...
   @section('content')
                    ...
                    <div class="card p-10">
                        <div class="row">
                            ...
                            <select class="form-control" name="status" id="status">
                                ...
                                <option value="R" {{($status  == 'R')?'selected':''}}>Recommended By DS</option>
                                <option value="C" {{($status  == 'C')?'selected':''}}>To Be Approved By AS</option>
                                       ...
                                       <tbody>
                                        @foreach ($user as $key=>$item)
                                            <tr>
                                                ...
                                                {{-- <td>{{date('d-m-y h:m:s',strtotime($item->approval_at))}}</td> --}}
                                                <td class="text-center">{{date('d-m-y',strtotime($item->approval_at))}}</td>
       ...
       <script>
         function filterBtn() {
            ...
            window.location.href = "/postRegister/" + statusid;
        }
       </script>
   @endsection
