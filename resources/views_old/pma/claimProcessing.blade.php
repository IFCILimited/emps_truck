                                                   ...
                                                   <table class="display table-bordered table-striped" id="export-button">
                                                       ...
                                                       <tbody>
                                                           ...
                                                           @if (count($claimMaster) > 0)
                                                               @foreach ($claimMaster->where('status', null) as $claim)
                                                                   <tr>
                                                                       @php
                                                                           $sn = $loop->iteration;
                                                                       @endphp
                                               ...
                                               <div class="dt-ext table-responsive  custom-scrollbar mt-5">
                                                   <table class="display table-bordered table-striped" id="export-button2">
                                                       ...
                                                       <tbody>
                                                           ...
                                                           @if (count($claimMaster) > 0)
                                                               @foreach ($claimMaster->whereNotNull('status') as $claim)
                                                                   <tr>
                                                                       @php
                                                                           $sn = $loop->iteration;
                                                                       @endphp
                               ...
                               $.ajax({
                                   ...
                                   success: function(response) {
                                       ...
                                       if (response === '') {
                                           ...
                                           Swal.fire('Vahan Processed Successfully').then(
                                               function() {
                                                   location
                               ...
                               $.ajax({
                                   ...
                                   success: function(response) {
                                       ...
                                       if (response === '') {
                                           ...
                                           Swal.fire('Claim Processed Successfully').then(
                                               function() {
                                                   location
                                               .reload(); // Reload the page after the success message
                                               });
                ...
                $.ajax({
                    ...
                    success: function(response, status, xhr) {
                        ...
                        if (xhr.status === 200) {
                            ...
                            var filename = (matches != null && matches[1]) ? matches[1] : 'claims.xlsx';
