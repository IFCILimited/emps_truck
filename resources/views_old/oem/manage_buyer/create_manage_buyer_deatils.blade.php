...
@section('content')
    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <form action="{{ route('manageBuyerDeatils.update', $bankDetail->id) }}" role="form" method="POST" class='form-horizontal modelcreate'
          ...
          <div class="modal-content">
            <div class="modal-body">
              <div class="modal-toggle-wrapper">
                <form action="{{route('manageBuyerDeatils.update', $bankDetail->id)}}"  id="formReject" role="form" method="POST"
