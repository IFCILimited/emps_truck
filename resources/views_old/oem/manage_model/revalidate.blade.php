...
@section('content')
    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <form action="{{ route('oemModel.revalidatestore') }}" role="form" method="post" class='form-horizontal prevent-multiple-submit' files=true
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 mb-3 ">
                                            ...
                                            <select class="form-select readonly" disabled name=""
                                                id="vehicle_category">
                                                <option value="{{$oemMOdelDetail->vehicle_cat_id}}">{{$oemMOdelDetail->vehicle_cat}}</option>
