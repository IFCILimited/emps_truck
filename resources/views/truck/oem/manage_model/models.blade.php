                                            ...
                                            <tr class="odd">
                                                ...
                                                <td class="text-center">
                                                    <span class="badge
                                                        ...
                                                        {{ $oem->pma_status == 'A' ? 'Recommended' : ($oem->pma_status == 'R' ? 'Rejected' : 'Pending') }}
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                        ...
                                                        @if ($oem->status == 'D')
                                                            <li>
                                                                <a class="btn btn-sm btn-warning"
                                                                    href="{{ route('e-trucks.oemModel.edit', encrypt($oem->id)) }}">Edit</a>
                                                            </li>
                                                        @else
                                                            <li>
                                                                <a class="btn btn-sm btn-success"
                                                                    href="{{ route('e-trucks.oemModel.show', encrypt($oem->id)) }}">View</a>
                                                            </li>
                                                        @endif
                                                    </ul>
                                                </td>
