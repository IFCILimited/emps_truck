                                        ...
                                        @foreach ($oemMOdelDetail as $key => $oem)
                                            <tr class="odd">
                                                        ...
                                                        @else --}}
                                                            <li>
                                                                <a class="btn btn-sm btn-success"
                                                                    href="{{ route('e-trucks.oemModel.models', encrypt($oem->model_id)) }}">View</a>
                                                            </li>
                                                        {{-- @endif --}}
                                                    </ul>
                                                </td>
                                                <td class="text-center">
                                                    ...
                                                    @if($disanbleButton)
                                                        <li>
                                                            <a class="btn btn-sm btn-info" href="{{ route('e-trucks.oemModel.revalidate', encrypt($oem->model_id)) }}">Re-Validate</a>
                                                        </li>
                                                    @else
                                                        <li>
