...
@section('content')
    <div class="page-body">
        <div class="container">
            <form action="{{ route('e-trucks.VinChassis.store') }}" method="POST">
                @csrf
                <div class="card">
                                    ...
                                    @if (isset($customerDetails) && $customerDetails)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('e-trucks.ackdoc.finalview', $customerDetails->id) }}" class="btn btn-primary">
                                                    View
                                                </a>
                                                @elseif($customerDetails->status == 'A' && $customerDetails->oem_status == Null)
                                                <a href="{{ route('e-trucks.manageBuyerDetails.create', $customerDetails->id) }}" class="btn btn-primary">
                                                    Create
                                                </a>
