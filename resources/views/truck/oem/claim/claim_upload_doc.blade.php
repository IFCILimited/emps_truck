        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ route('e-trucks.claimDocStore') }}" id="creUser" role="form" method="POST"
                        ...
                        <div class="row col-12">
                            <div class="col-md-4 text-left">
                                <a href="{{ route('e-trucks.claimSubmitted') }}" class="btn btn-warning">Back</a>
                            </div>
                    ...
                    <form action="{{ route('e-trucks.claimDocUpdate') }}" id="creUser" role="form" method="POST"
                        class='form-horizontal prevent-multiple-submit' files=true enctype='multipart/form-data' accept-charset="utf-8">
                        @csrf
                        <div class="card">
                            <div class="card-body">
