       ...
       <div class="page-body">
           ...
           <div class="container-fluid">
               <div class="row">
                    ...
                    <form action="{{route('e-trucks.claimGenerate.store')}}" role="form" method="post" class='form-horizontal' id='proceedClaimForm'
...
<div id="vcat"></div>
                   ...
                   <div class="row py-2">
                        <div class="col-md-2 offset-md-0">
                            <a href="{{route('e-trucks.claimGenerate.index')}}" class="btn btn-warning btn-sm form-control form-control-sm font-weight-bold"><i
