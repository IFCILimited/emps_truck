   ...
   @section('content')
       ...
       <div class="page-body">
           ...
           <div class="container-fluid">
               <div class="row">
                    <form action="{{route('e-trucks.claimToMhi.store')}}" role="form" method="post" class='form-horizontal' id='proceedClaimForm'
                   ...
                   <div class="row py-2">
                        <div class="col-md-2 offset-md-0">
                            <a href="{{route('e-trucks.claimToMhi.index')}}" class="btn btn-warning btn-sm form-control form-control-sm font-weight-bold"><i
