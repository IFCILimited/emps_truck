       ...
       <div class="page-body">
           ...
           <div class="container-fluid">
               <div class="row">
                <div class="col-sm-12">
                    <p>
                        <b>Total Number Of Vehicles = {{$bdCount}}</b>&nbsp;&nbsp;<a href="{{route('e-trucks.bulkdownloadBuyerList',['status' => $status])}}" class="btn btn-primary btn-sm"> Download<i class="fa fa-download"></i></a><br>
                                   ...
                                   <table class="display table-bordered  table-striped" id="export-button">
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ date('d-m-y',strtotime($bankDetail->oem_action_at)) }} </td>
                                            <td>  <span style="color: red;">Reject With Reason: </span> <b>{{ $bankDetail->oem_remrk }}</b></td>
                                            <td>
