...
@section('content')
    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <form action="{{ route('e-trucks.buyerdetail.multi_update', $bankDetail->id) }}" role="form" method="POST"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3" id="">
                                            ...
                                            <input type="text" class="form-control readonly" id="custmr_name"
                                                name="custmr_name" value="{{$multiBuyerDetail->customer_name}}" readonly>
                                    ...
                                    <table class="table table-stripped table-bordered" id="multiVinTable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('e-trucks.buyerdetail.manage_invoice_preview', [$bd_id, encrypt($rowId), 'edit', 'oem']) }}" class="btn btn-info">View</a>
                                            </td>
                ...
                <div class="col-12 d-flex justify-content-center align-items-center">
                    <div style="margin-left: 1rem;">
                        <a type="button" class="btn btn-info" href="{{ route('e-trucks.manageBulkBuyerDetails.index', 'P') }}" class="btn btn-warning">Back</a>
                    </div>
                    <div style="margin-left: 1rem;">
                        <button type="button" class="openModal btn btn-success" data-action="appr">Approve</button>
                    </div>
                    <div style="margin-left: 1rem;">
                        <button type="button" class="openModal btn btn-danger" data-action="revrt" data-toggle="modal" data-target="#confirm">
                            Revert
                        </button>
                    </div>
                </div>
        ...
        <div class="modal fade" id="confirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="updateForm" action="{{ route('e-trucks.manageBulkBuyerDetails.action', encrypt($rowId)) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="modal-footer">
                            <button id="check_btn" type="button" class="btn btn-primary" style="background-color: #007bff; border: none;">Revert -></button>
                        </div>
                    </form>
                </div>
            </div>
...
$('#check_btn').on("click", function(event) {
    ...
    $('.openModal').on("click", function(){
        ...
        $('#action').val(this.getAttribute("data-action"));

        if(this.getAttribute("data-action") == "appr"){
            Swal.fire({
                title: "Are you sure?",
                text: "You are about to submit the form. Are you sure you want to proceed?",
                icon: "warning",
