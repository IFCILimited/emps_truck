       ...
       <div class="page-body">
           ...
           <div class="container-fluid">
               <div class="row">
                ...
                <div class="col-sm-12">
                    <p>
                        <b>Total Number Of Vehicles = {{$bdCount}}</b>&nbsp;&nbsp;<a href="{{route('bulkdownloadBuyerList',['status' => $status])}}" class="btn btn-primary btn-sm"> Download<i class="fa fa-download"></i></a><br>
                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if($bankDetail->status == 'A' && $bankDetail->oem_status == 'A')
                                                <a href="{{route('e-trucks.buyerdetail.multi_buyer_preview', [encrypt($bankDetail->id),'oem'])}}" class="btn btn-success">View</a>
                                            @elseif($bankDetail->status == 'A')
                                                <a href="{{route('e-trucks.manageBulkBuyerDetails.create', [encrypt($bankDetail->id)])}}" class="btn btn-primary">Create</a>
                                            @endif
                                            </td>
                                        </tr>
                                        @endforeach
