...
@if($bankDetail->pmedrive_dealer_status == 'S' && $bankDetail->pmedrive_oem_status == null)
    <form action="{{ route('e-trucks.Empsbuyer.update', encrypt($bankDetail->id)) }}" role="form" method="POST"
    ...
    <div class="row col-12">
        <div class="col-md-4 text-left">
            <a href="{{ route('e-trucks.Empsbuyer.index', 'P') }}" class="btn btn-warning">Back</a>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="modal-toggle-wrapper">
                    <form action="{{route('e-trucks.Empsbuyer.update', encrypt($bankDetail->id))}}" id="formReject" role="form"
