                                        ...
                                        @if (isset($modelMaster))
                                            @foreach ($modelMaster as $model)
                                                ...
                                                <tr>
                                                    ...
                                                    @elseif($model->productionDataStatus == 'D')
                                                    <td class="text-center">
                                                        <a href="{{ route('e-trucks.manageProductionData.edit', encrypt($data)) }}"
                                                        ...
                                                        <td class="d-flex justify-content-around m-2">
                                                            ...
                                                            {{-- @if ($model->isProductionDraft)
                                                                <a href="{{ route('manageProductionData.edit', encrypt($data)) }}"
                                                                    class="btn  btn-warning">Edit AD</a>
                                                            @else --}}
                                                    ...
                                                    <div class="modal-dialog modal-lg modal-dialog-centered"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('e-trucks.uploadProductionData') }}"
