            ...
            <div class="page-title">
                <div class="row">
                    ...
                    <div class="col-3 d-flex justify-content-end">
                        <a href="{{ route('e-trucks.vinFiledownload') }}" class="btn btn-success"><i class="fa fa-cloud-download"></i> Download Format.</a>
                    </div>
                    {{-- <div class="col-3 d-flex justify-content-end">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="dt-ext table-responsive custom-scrollbar">
                                <form action="{{ route('e-trucks.upload.vinexcel') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
