                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @if(!Auth::user()->hasRole('PMA'))
                            <a class="btn btn-info" href="{{ route('e-trucks.manageCompanyDetails.create') }}">New Request</a>
                        @endif
                    </div>
                    <div class="col-12 pt-2 pb-2" style="max-width: 90%;margin: 0 auto;">
                        ...
                        <table class="table stripped" style="padding: 0 1rem">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{route('e-trucks.manageCompanyDetails.show', $det->id)}}">
