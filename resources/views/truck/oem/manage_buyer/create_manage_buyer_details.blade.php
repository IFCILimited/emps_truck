                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 mb-3" id="">
                                        ...
                                        <input type="date" class="form-control srchV readonly"
                                            value="{{ date('Y-m-d', strtotime($bankDetail->manufacturing_date)) }}"
                                            id="" name="manufacturing_date" readonly>
                                    </div>
                                    <div class="col-4 mb-3" id="">
                                        <label class="form-label" for="manu_date">Gross Vehicle Weight (GVW in
                                            Tons):</label>
                                        <input class="form-control srchV readonly"
                                            value="{{ $bankDetail->gross_weight }}" id="" name="gvw"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="{{ $col }} mb-3"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control readonly" readonly id="gen"
                                                name="gender"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-toggle-wrapper">
                        <form action="{{ route('e-trucks.manageBuyerDetails.update', $bankDetail->id) }}" id="formReject"
                            role="form" method="POST" class='form-horizontal modelVer' accept-charset="utf-8"
                            ...
                            <input type="hidden" name='dealer_id' value="{{ $user->id }}">
                            <input type="hidden" value="{{ $bankDetail->segment_id }}" class="form-control"
                                id="seg_id" name="segment_id">
                            <input type="hidden" value="{{ $bankDetail->id }}" class="form-control" id="id"
                                name="id">

                            <input type="hidden" name='production_id' value="{{ $bankDetail->production_id }}"
                                id="prd_id">
                            <div class="row">
                                <div class="col-12">
                                    <label>Remarks</label>
