                           ...
                           <div class="card-body">
                               <div class="dt-ext table-responsive  custom-scrollbar">
                                   <table class="display table-bordered  table-striped" id="export-button">
                                       ...
                                       <tbody>
                                        @foreach ($bankDetails->whereNotIn('oem_status',['R']) as $key => $bankDetail)
                                        <tr>
                                            <td>{{$key+1}}</td>
                                        ...
                                        @endif
                                            ...
                                            <a href="{{route('e-trucks.ackdoc.finalview', $bankDetail->id)}}" class="btn btn-success">View</a>
                                            @elseif($bankDetail->status == 'A')
                                                <a href="{{route('e-trucks.manageBuyerDetails.create', $bankDetail->id)}}" class="btn btn-primary">Create</a>
                                            @endif
                                            </td>
                                        </tr>
                                        @endforeach
