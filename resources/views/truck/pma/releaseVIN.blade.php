   ...
   @section('content')
       <div class="page-body">
           ...
           <div class="container-fluid">
            <form action="{{route("e-trucks.releaseVIN.getVIN")}}" method="post">
                @csrf
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            @if($details->buyer_id == null)
                                                            <button  data-method="release" type="button" class="openModal btn btn-sm btn-primary text-uppercase" data-toggle="modal" data-target="#confirm">
                                                                Release
                                                            </button>
                                                            @else
                                                             <span class="text-danger">Already Customer ID Generated</span>
                                                            @endif
                                                        </div>
                                                    </td>
                                                </tr>
                    ...
                    <div class="modal fade" id="confirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form id="updateForm" action="{{ route('e-trucks.releaseVIN.update', encrypt($details->id)) }}" method="post">
                                    @csrf
                                    @method('PUT')
...
$(document).ready(function() {
        $('#check_btn').on("click", function(event) {
            ...
            Swal.fire({
            title: "Warning!",
            text: "If you choose to proceed with this request, VINs connected to the provided customer ID will be released, and this data will no longer be retrievable.",
            icon: "warning",
            showDenyButton: true,
