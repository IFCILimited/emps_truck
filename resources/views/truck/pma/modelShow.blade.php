   ...
   @section('content')
       ...
       <div class="page-body">
           ...
           <div class="container-fluid">
               <div class="row">
                   <div class="col-sm-12">
                       <form action="{{route('e-trucks.manageOEMApproval.store')}}" id="plant" role="form" method="POST" class='form-horizontal modelVer' files=true
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            ...
                                            name="factory_price"
                                            value="{{$model->testing_factory_price}}">                                         </div>
                            ...
                            @if(Auth::user()->hasRole('MHI-DS'))
                                ...
                                @if($model->pma_status != null || $model->pma_status != '')
                                    @if($model->mhi_flag == null || $model->mhi_flag == '')
                                        ...
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-info btn-approve" name="mhi_recomend">Approve</button>
                            ...
                            @elseif(Auth::user()->hasRole('PMA'))
                                @if ($model->pma_status == null)
                                    {{-- @if($model->mhi_flag == null || $model->mhi_flag == '') --}}
                                        ...
                                        <input type="hidden" name="mid" value="{{$model->model_detail_id}}">
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-info btn-approve" name="pma_recomend">Recommend</button>
                                            <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#reject">Reject</button>
                                        </div>
                                    {{-- @endif --}}
                                @endif
                   ...
                   <div class="col-4">
                    <a href="{{ route('e-trucks.modelDetails') }}" class="btn btn-warning">Back</a>
            </div>
               </div>
           </div>
       </div>
          ...
          <div class="modal-content">
            <div class="modal-body">
              <div class="modal-toggle-wrapper">
                <form action="{{route('e-trucks.manageOEMApproval.store')}}"  id="formReject" role="form" method="POST"
                   ...
                   <input type="hidden" name="mid" value="{{$model->model_detail_id}}">
                    ...
                    <div class="col-12">
                        <button class="btn bg-primary mt-2 d-flex align-items-center gap-2 text-light ms-auto btnReject" type="submit"
                            @if(Auth::user()->hasRole('MHI-DS') )
                                name="mhi_reject"
                            @else
                                name="pma_reject"
                            @endif
                            >Reject<i data-feather="arrow-right"></i>
                        </button>
                    </div>
                </form>
              </div>
