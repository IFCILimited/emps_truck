                                                           ...
                                                           @if (count($claimMaster) > 0)
                                                               @foreach ($claimMaster->where('pma_process_at', null) as $claim)
                                                                ...
                                                                <input type="checkbox" name="check[{{$sn}}]" claimid="{{($claim->lot_id)}}" class="btnShowClass" value="{{($claim->lot_id)}}"/>
                                                                       ...
                                                                       <td><a
                                                                               href="{{ route('e-trucks.viewclaims', encrypt($claim->claim_id)) }}">{{ $claim->claimnumberformat }}</a>
                                                                       </td>
								...
								<th scope="col">Documents</th>
                                                       ...
                                                       <tbody>
                                                        ...
                                                        <input type="checkbox" name="check[{{$sn}}]" claimid="{{($claim->lot_id)}}" class="btnShowClass" value="{{($claim->lot_id)}}"/>
                                                                      ...
                                                                      <td>
                                                        <a href="{{ route('e-trucks.downloadClaim', $claim->claim_id) }}" class="btn btn-sm btn-warning"><i class="fa fa-download"></i></a>
                                                    </td> 
                                @if($claim->claim_doc_status  == 'A')
                                <td><a href="{{route('e-trucks.claimUploadDoc',encrypt($claim->claim_id))}}" class="btn btn-sm btn-success">View Documents</a></td>
                                @else
