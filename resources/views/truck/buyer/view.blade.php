            ...
            <div class="row" id="backBtn">
                <div class="col-4">
                    @if (Auth::user()->hasRole('DEALER'))
                        <a href="{{ route('e-trucks.buyerdetail.index') }}" class="btn btn-warning form-control-sm mt-2"
                            type="" id="">Back</a>
                    ...
                    <a href="{{ route('e-trucks.claimProcessing') }}" class="btn btn-warning form-control-sm mt-2"
                        type="" id="">Back</a>
                    @endif
                </div>
            </div>
