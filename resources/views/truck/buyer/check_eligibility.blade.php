...
@section('content')
    ...
    <div class="page-body">
        ...
        <div class="container-fluid mt-4">
            <form action="{{ route('e-trucks.checkEligibility.store') }}" role="form" method="post" class='form-horizontal prevent-multiple-submit' files=true
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                            <div class="card-body">
                                            <span>
                                            Note: The <b>"Check Eligibility"</b> tab is only for </span><span class="text-danger"><b>individual customers.</b></span>
