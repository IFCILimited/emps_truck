            ...
            <div class="row mt-">
                <div class="col-md-4">
                    <div class="card card-1">
                        <div class="card-body">
                            <h5 class="card-title text-center ">Models Available (Active)</h5>
                            <p class="card-text text-center">{{$model_detail}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-2">
                        <div class="card-body">
                            <h5 class="card-title text-center">Fuel saving per day (in Litres)</h5>
                            <p class="card-text text-center">{{ indian_format($carbonData->total_fuelsaved_perday) }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-3">
                        <div class="card-body">
                            <h5 class="card-title text-center">Total Saved Fuel (in Litres)</h5>
                            <p class="card-text text-center">{{ indian_format($carbonData->total_fuel_saved) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                <div class="row">
                    ...
                    <div class="card card-4">
                        <div class="card-body">
                            ...
                            <p class="card-text text-center">{{ indian_format($carbonData->co2perday) }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card card-5">
                        <div class="card-body">
                            ...
                            <p class="card-text text-center">{{ indian_format($carbonData->co2total) }}</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="verifyDoc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="verify_Cert_form" action="{{route('e-trucks.dealer.check_and_Verify_certificate')}}" method="post">
                    @csrf
