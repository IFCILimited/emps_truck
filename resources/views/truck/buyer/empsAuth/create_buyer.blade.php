       ...
       <div class="page-body">
           <div class="container-fluid">
            ...
            <div class="container  mt-2">
                <form action="{{ route('e-trucks.empsbuyer.store') }}" method="POST">
                    @csrf
                    <div class="card">
                                    ...
                                    <tbody>
                                        @if (isset($customerDetails) && $customerDetails['status'] == 'SuccessE')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('e-trucks.empsbuyer.show_detail', ['id' => encrypt($customerDetail['id']), 'data' => json_encode($customerDetails['message'])]) }}" class="btn btn-primary">
                                                        Create
                                                    </a>
                                                </td>
                                            </tr>
