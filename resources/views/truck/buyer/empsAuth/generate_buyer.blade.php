   ...
   @section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <a class="btn btn-success btn-sm" style="display: none" id="cut_id_doc_1"
                                            href="{{ route('e-trucks.doc.down', encrypt($bankDetail[0]['copy_file_uploadid'])) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <a class="btn btn-success btn-sm"
                                            href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail[0]['sec_file_uploadeid'])) }}">
                                            <i class="fa fa-download"></i> View Certificate
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <a class="btn btn-success btn-sm"
                                href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail[0]['cst_ack_file'])) }}">
                                <i class="fa fa-download"></i> View Certificate
                            </a>
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <a class="btn btn-success btn-sm"
                                href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail[0]['invc_copy_file'])) }}">
                                <i class="fa fa-download"></i> View Certificate
                            </a>
                        </div>
                        <div class="col-4 mb-3 ">
                            <label class="form-label" for="minimax_speed">Vehicle Registration
                                Copy:</label><br>
                            <a class="btn btn-success btn-sm"
                                href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail[0]['vhcl_reg_file'])) }}">
                                <i class="fa fa-download"></i> View Certificate
                            </a>
                        </div>
                    </div>
    ...
    <div class="card-header d-flex justify-content-between align-items-center position-relative">
        <div class="col-4">
            <a href="{{ route('e-trucks.empsbuyer.index') }}" class="btn btn-warning form-control-sm mt-2" id="">Back</a>
        </div>
        <div class="position-absolute start-50 translate-middle">
            <a href="{{ route('e-trucks.empsbuyer.create', ['emps_id' => $bankDetail[0]['id'], 'data' => json_encode($bankDetail)]) }}"
