   ...
   @section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <a class="btn btn-success btn-sm" style="display: none" id="cut_id_doc_1"
                                            href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail->copy_file_uploadid)) }}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select disabled class="form-select" name="addi_cust_id"
                                            ...
                                            <option value="{{ $bankDetail->addi_cust_id}}">{{$type->name}}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <a class="btn btn-success btn-sm"
                                            href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail->sec_file_uploadeid)) }}">
                                            <i class="fa fa-download"></i> View Certificate
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <a class="btn btn-success btn-sm"
                                href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail->cst_ack_file)) }}">
                                <i class="fa fa-download"></i> View Certificate
                            </a>
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <a class="btn btn-success btn-sm"
                                href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail->invc_copy_file)) }}">
                                <i class="fa fa-download"></i> View Certificate
                            </a>
                        </div>
                        <div class="col-4 mb-3 ">
                            <label class="form-label" for="minimax_speed">Vehicle Registration
                                Copy:</label><br>
                            <a class="btn btn-success btn-sm"
                                href="{{ route('e-trucks.empsdoc.down', encrypt($bankDetail->vhcl_reg_file)) }}">
                                <i class="fa fa-download"></i> View Certificate
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control" type="date" name="dob" disabled
                            value="{{ date('Y-m-d', strtotime($bankDetail->pmedrive_adh_dob)) }}">
                    </div>
                </div>
            </div>
        </div>
    ...
    @if ($bankDetail->pmedrive_dealer_status == 'D')
        <form action="{{ route('e-trucks.empsbuyer.update', $bankDetail->id) }}" role="form" method="POST"
            class='form-horizontal modelcreate' files=true enctype='multipart/form-data' id="empsAuth"
        ...
        <div class="card height-equal">
            <div class="card-header d-flex justify-content-between">
                ...
                <br>
                <a href={{route('e-trucks.empsbuyer.download', encrypt($bankDetail->buyer_id))}} class="btn btn-info">
                    Generate E-Voucher
                </a>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-3 mb-3">
                        ...
                        <label class="form-label" for="max_electric_energy_consumption">
                            ...
                            <input class="form-control docs_upload" data-target="evoucher" id="evoucher_copy_file" type="file"
                            name="evoucher_copy_file">
                            <br>
                            @if($bankDetail->pmedrive_evoucher_copy_id != null)
                            <input type="hidden" name="pmedrive_evoucher_copy_id_exist" value="{{$bankDetail->pmedrive_evoucher_copy_id}}"/>
                            <a class="btn btn-success btn-sm"
                            href="{{ route('e-trucks.doc.down', encrypt($bankDetail->pmedrive_evoucher_copy_id)) }}">
                            <i class="fa fa-download"></i> View Certificate
                        </a>
                        @endif
                    </div>
                    <div class="col-3 mb-3">
                        <label class="form-label" for="max_electric_energy_consumption">
                            ...
                            <input class="form-control docs_upload" data-target="evoucher" id="cust_selfie_copy" type="file"
                            name="cust_selfie_copy">
                            <br>
                            
                            @if($bankDetail->pmedrive_self_copy_id != null)
                            <input type="hidden" name="pmedrive_self_copy_id_exist" value="{{$bankDetail->pmedrive_self_copy_id}}"/>
                            <a class="btn btn-success btn-sm"
                            href="{{ route('e-trucks.doc.down', encrypt($bankDetail->pmedrive_self_copy_id)) }}">
                            <i class="fa fa-download"></i> View Certificate
                        </a>
                        @endif
    ...
    <div class="card-header d-flex justify-content-between">
        <div class="col-4">
            <a href="{{ route('e-trucks.empsbuyer.emps_auth') }}" class="btn btn-warning form-control-sm mt-2"
                type="" id="">Back</a>
    </div>
    @if ($bankDetail->pmedrive_dealer_status == 'D')
        <div class="d-flex">
            <button class="btn btn-primary form-control-sm mt-2" type="button" id="updateBtn">Update</button>
        </div>
        <div class="d-flex justify-content-center">
            <button class="btn btn-primary form-control-sm mt-2" type="button" id="submitToOEMBtn">Submit to OEM</button>
        </div>
    @endif
...
$(document).ready(function() {
    ...
    $('#updateBtn').on('click', function(event) {
        ...
        $('.modelcreate').submit(); // Uncomment this line to submit the form after updating status
    ...
    $('#submitToOEMBtn').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $('.modelcreate').submit(); // Uncomment to submit the form after status update
