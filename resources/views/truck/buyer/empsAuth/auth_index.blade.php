                ...
                {{-- <form action="{{route("empsbuyer.create")}}" method="post"> --}}
                            ...
                            <div style="display: flex;align-items: center;justify-content: space-between;">
                                <div style="display: flex;align-items: center;">
                                    <form action="{{route("e-trucks.empsbuyer.export_data")}}" method="post">
                                        @csrf
                                        <button class="btn btn-sm btn-primary" type="submit">Export CSV</button>
                                    </form>

                                    <div style="margin-left: 10px">
                                        <form action="{{route("e-trucks.empsbuyer.emps_auth")}}" method="get" style="display: flex">
                                            @csrf
                                            ...
                                            <a href="{{route("e-trucks.empsbuyer.emps_auth")}}" class="btn btn-info" style="margin-left: 1rem;">Refresh</a>
                                        </form>
                                           ...
                                           @foreach ($empsAuthBuyer as $key => $empsAuthBuyers)
                                               <tr>
                                                   ...
                                                   <td class="text-center">
                                                       ...
                                                       @else
                                                           @if ($empsAuthBuyers->pmedrive_dealer_status == 'D')
                                                               <a href="{{ route('e-trucks.empsbuyer.edit',encrypt($empsAuthBuyers->id)) }}"
