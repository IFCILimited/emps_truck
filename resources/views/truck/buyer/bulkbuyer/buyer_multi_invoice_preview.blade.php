                    ...
                    <div class="text-left">
                        @if($userType == 'deal')
                            @if($flag == 'prev')
                                ...
                                <a href="{{ route('e-trucks.buyerdetail.multi_buyer_preview', [encrypt($rowId), 'deal']) }}" class="btn btn-warning">Back</a>
                            @else
                                {{-- send back to dealer edit page --}}
                                <a href="{{ route('e-trucks.buyerdetail.multi_detail_edit', encrypt($rowId)) }}" class="btn btn-warning">Back</a>
                            @endif
                        @elseif($userType == 'pma')
                        ...
                        @else
                            @if($flag == 'edit')
                                ...
                                <a href="{{ route('e-trucks.manageBulkBuyerDetails.create', encrypt($rowId)) }}" class="btn btn-warning">Back</a>
                            @else
                                {{-- send back to oem preview page --}}
                                <a href="{{ route('e-trucks.buyerdetail.multi_buyer_preview', [encrypt($rowId), 'oem']) }}" class="btn btn-warning">Back</a>
                            @endif
