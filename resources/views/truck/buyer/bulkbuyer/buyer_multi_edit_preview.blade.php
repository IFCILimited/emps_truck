    ...
    <div class="page-body">
        ...
        <div class="container-fluid">
            <form action="{{ route('e-trucks.buyerdetail.multi_update', $bankDetail->id) }}" role="form" method="POST"
                                ...
                                <div class="card-body">
                                    <table class="table table-stripped table-bordered" id="multiVinTable">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 mb-3" id="">
                                                        ...
                                                        <input class="form-control srchV readonly" id="addmi_inc_amt" name="addmi_inc_amt" value="{{$productionDetails[$vin]->addmi_inc_amt}}"
                                                            readonly>
                                                    </div>
                                                    {{-- <div class="col-4 mb-3" id="">
                                            ...
                                            <td>
                                                @if( $userType == "deal" )
                                                    <a href="{{ route('e-trucks.buyerdetail.manage_invoice_preview', [$bd_id, encrypt($rowId), 'prev', 'deal']) }}" class="btn btn-info">View</a>
                                                @else
                                                    <a href="{{ route('e-trucks.buyerdetail.manage_invoice_preview', [$bd_id, encrypt($rowId), 'prev', 'oem']) }}" class="btn btn-info">View</a>
                                                @endif
                                            </td>
                ...
                <div class="text-left">
                    @if( $userType == "deal" )
                        <a href="{{ route('e-trucks.buyerdetail.multi_buyers') }}" class="btn btn-warning">Back</a>
                    @else
                        {{-- <a href="{{ route('manageBulkBuyerDetails.index', 'A') }}" class="btn btn-warning">Back</a> --}}
                        <a href="{{ route('e-trucks.manageBulkBuyerDetails.index', $multiBuyerDetail->oem_status) }}" class="btn btn-warning">Back</a>
                    @endif
                </div>
