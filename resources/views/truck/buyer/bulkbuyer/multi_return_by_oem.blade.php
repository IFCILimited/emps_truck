                            ...
                            <div style="display: flex;align-items: center;justify-content: space-between;">
                                <div style="display: flex;align-items: center;">
                                    ...
                                    <div style="margin-left: 10px">
                                        <form action="{{route("e-trucks.buyerbulk.oemreturn")}}" method="get" style="display: flex">
                                            @csrf
                                            ...
                                            <a href="{{route("e-trucks.buyerbulk.oemreturn")}}" class="btn btn-info" style="margin-left: 1rem;">Refresh</a>
                                        </form>
                                   ...
                                   <table class="display table-bordered table-striped" id="buyer_details_table">
                                       <thead>
                                           <tr>
                                               ...
                                               <th class="text-center">OEM Remarks</th>
                                       ...
                                       <tbody>
                                        ...
                                        @endphp
                                               <tr>
                                                   ...
                                                   <td class="text-center">{{ $bankDetail->oem_remrk }} </td>
