        ...
        <div class="container-fluid">
            <form action="{{ route('e-trucks.buyerdetail.multi_update', $bankDetail->id) }}" role="form" method="POST"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($productionDetails[$vin]->status == 'S')
                                                    <a href="{{ route('e-trucks.buyerdetail.manage_invoice_preview', [$bd_id, encrypt($rowId), 'edit', 'deal']) }}" class="btn btn-success">View Details</a>
                                                @else
                                                    <a href="{{ route('e-trucks.buyerdetail.manageInvoice', [$bd_id, encrypt($rowId)]) }}" class="btn btn-primary">Add Details</a>
                                                @endif
                                            </td>
                                            {{-- <td>
                ...
                <div style="display: flex;justify-content: space-evenly;align-items: center;">
                    ...
                    <div class="text-end">
                        <form id="subitOemForm" method="post" action="{{route('e-trucks.buyerdetail.submit_oem')}}">
                            @csrf
