...
@section('content')
    <div class="page-body">
        <div class="container">
            <form action="{{ route('e-trucks.Evoucher.store') }}" method="POST">
                @csrf
                <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($customer->custmr_typ == 1)
                                                    <a href={{route('e-trucks.dealer.view_certificate', encrypt($customer->buyer_id))}} class="btn btn-info">
                                                        View E-Voucher
                                                    </a>
                                                @else
                                                <a href={{route('e-trucks.dealer.multiBuyerVoucher', encrypt($customer->id))}} class="btn btn-primary">
                                                    View E-Voucher
                                                  </a>
                                                @endif
                                            </td>
