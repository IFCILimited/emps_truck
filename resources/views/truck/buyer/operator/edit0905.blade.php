        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ route('e-trucks.manageOperator.update',encrypt($dealerReg->id)) }}" id="creDealer" role="form" method="POST"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class=" row">
                                	...
                                	<input type="hidden" name="oem_id" value="{{$oemIdCheck}}">                                
			        <div class=" row mt-2">
                        ...
                        <div class="row col-12">
                            <div class="col-md-4 text-left">
                                <a href="{{ route('e-trucks.manageOperator.index') }}" class="btn btn-warning">Back</a>
                            </div>
