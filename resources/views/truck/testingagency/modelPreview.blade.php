   ...
   @section('content')
       ...
       <div class="page-body">
           ...
           <div class="container-fluid">
               <div class="row">
                   <div class="col-sm-12">
                       <form action="{{ route('e-trucks.modelRequests.store') }}" id="plant" role="form" method="POST"
                           class='form-horizontal modelVer prevent-multiple-submit' files=true enctype='multipart/form-data'
                           accept-charset="utf-8">
                           @csrf
                           {{-- {!! method_field('patch') !!} --}}
                           <div class="card">
                            {{-- <input type="hidden" name="fullRequest" value="{{json_encode($request->all())}}" id=""> --}}
                            <input type="hidden" name="modelDoc_id" value="{{$modelDoc_id}}" id="">
                            <input type="hidden" name="cmvrid" value="{{$cmvrid}}" id="">
                            <input type="hidden" name="assessment_id" value="{{$assessment_id}}" id="">
                    ...
                    <input type="hidden" name="oem_name" value="Tvs Motor Company Limited"> --}}
                               <div class="card-body">
                                   <div class="row g-3">
                                    ...
                                    <div class="col4"></div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control {{ $model->factory_price == $request->factory_price ? 'readonly' : 'bg-danger' }}" name="factory_price"
                                               value="{{ $request->factory_price }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control {{ $model->spec_density == $request->spec_density ? 'readonly' : 'bg-danger' }}" name="spec_density"
                                               value="{{ $request->spec_density }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control {{ $model->life_cyc == $request->life_cyc ? 'readonly' : 'bg-danger' }}" name="life_cyc"
                                               value="{{ $request->life_cyc }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control {{ $model->min_ex_show_price == $request->min_ex_show_price ? 'readonly' : 'bg-danger' }}" name="min_ex_show_price"
                                               value="{{ $request->min_ex_show_price }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" readonly class="form-control readonly"
                                               value="{{ $model->estimate_incentive_amount }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control {{ $model->range == $request->range ? 'readonly' : 'bg-danger' }}" name="range"
                                               value="{{ $request->range }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control {{ $model->max_elect_consumption == $request->max_elect_consumption ? 'readonly' : 'bg-danger' }}" name="max_elect_consumption"
                                               value="{{ $request->max_elect_consumption }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" name="min_max_speed" class="form-control {{ $model->min_max_speed == $request->min_max_speed ? 'readonly' : 'bg-danger' }}"
                                               value="{{ $request->min_max_speed }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control {{ $model->min_acceleration == $request->min_acceleration ? 'readonly' : 'bg-danger' }}" name="min_acceleration"
                                               value="{{ $request->min_acceleration }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <select id="" class="form-select {{ $model->meeting_tech_function == $request->meeting_tech_function ? 'readonly' : 'bg-danger' }}" name="meeting_tech_function">
                                               <option>Select</option>
                                               <option value="Y"
                                                   {{ $request->meeting_tech_function == 'Y' ? 'selected' : '' }}>Yes</option>
                                               <option value="N"
                                                   {{ $request->meeting_tech_function == 'N' ? 'selected' : '' }}>No</option>
                                           </select>
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <select id="" class="form-select {{ $model->meeting_qualif == $request->meeting_qualif ? 'readonly' : 'bg-danger' }}" name="meeting_qualif">
                                               <option>Select</option>
                                               <option value="Y" {{ $request->meeting_qualif == 'Y' ? 'selected' : '' }}>
                                                   Yes</option>
                                               <option value="N" {{ $request->meeting_qualif == 'N' ? 'selected' : '' }}>
                                                   No</option>
                                           </select>
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="date" class="form-control {{ $model->vehicle_sub_to_test_agency_apprv == $request->vehicle_sub_to_test_agency_apprv ? 'readonly' : 'bg-danger' }}"
                                               name="vehicle_sub_to_test_agency_apprv"
                                               value="{{ $request->vehicle_sub_to_test_agency_apprv }}">
                                       </div>
                                       <hr/>
                                       ...
                                       @endif --}}
                                       <div class="col-4">
                                        <p><b>PM E-DRIVE Compliance Certificate Number*</b></p>
                                    </div>
                                    <div class="col-4">

                                    </div>
                                    <div class="col-4">
                                        <input type="text" name="certificate_no" value="{{$request->certificate_no}}" class="form-control readonly"
                                       ...
                                       <div class="col-4">
                                           <input type="hidden" value="{{ $request->file('certificate') ? $request->file('certificate')->getClientOriginalName() : '' }}"  name="certificate" class="form-control">
                                           <a class="mt-2 btn btn-success btn-sm"
                                           href="{{ route('doc.down', encrypt($modelDoc_id)) }}">
                                    ...
                                    <div class="col-4">
                                        <input type="hidden" value="{{ $request->file('assessment_report') ? $request->file('assessment_report')->getClientOriginalName() : '' }}"  name="assessment_report" class="form-control">
                                        <a class="mt-2 btn btn-success btn-sm"
                                        href="{{ route('doc.down', encrypt($assessment_id)) }}">
                                        <i class="fa fa-download"></i>  View Document
                                     </a>
                                    </div>
                                       ...
                                       <div class="col-4">
                                           ...
                                           <span class="text-danger">(Please also upload all earlier certificates in a single
                                               file.)</span>
                                       </div>
                                       <div class="col-4">
                                       </div>
                                       <div class="col-4">
                                           <input type="hidden" value="{{ $request->file('cmvr_certificate') ? $request->file('cmvr_certificate')->getClientOriginalName() : '' }}"" name="cmvr_certificate" class="form-control">
                                           <a class="mt-2 btn btn-success btn-sm"
                                           href="{{ route('doc.down', encrypt($cmvrid)) }}">
                                           <i class="fa fa-download"></i>  View Document
                                        </a>
                                       </div>
                                       <div class="col-4">
                                       ...
                                       <div class="col-4">
                                           <input type="date" name="cmvr_date" value="{{ $request->cmvr_date }}"  class="form-control readonly">
                                       </div>
                                       {{-- <div class="col-4">
                                           <p><b>PM E-DRIVE Compliance Certificate Date:*</b></p>
                                       </div>
                                       <div class="col-4">
                                       </div>
                                       <div class="col-4">
                                           <input type="date" name="cmvr_date" value="{{ $request->cmvr_date_new }}" class="form-control readonly"
                                               placeholder="Select PM E-DRIVE Date">
                                       </div> --}}
                                       ...
                                       <div class="col-4">
                                           <input type="date" name="approval_date" value="{{ $request->approval_date }}" class="form-control readonly"
                                               placeholder="Select Approval Date">
                                       </div>
                                       <div class="col-4">
                                           <p><b>{{ env('APP_NAME') }} Compliance Certificate Valid from:*</b></p>
                                       </div>
                                       <div class="col-4">

                                       </div>
                                       <div class="col-4">
                                           <input type="date" name="valid_date" value="{{ $request->valid_date }}" class="form-control readonly"
                                               placeholder="Select Validate Date">
                                       </div>

                                       <div class="col-4">
                                           <p><b>Model {{ env('APP_NAME') }} Compliance Certificate Valid Upto:*</b></p>
                                       </div>
                                       <div class="col-4">

                                       </div>
                                       <div class="col-4">
                                           <input type="date" name="expiry_date" value="{{ $request->expiry_date }}" class="form-control readonly"
                                               placeholder="Select Validate Date">
                                       </div>
                                       <div class="col-4">
                                       ...
                                       <div class="col-4">
                                           <select id="" class="form-select readonly" name="pmp_compliance">
                                               <option selected disabled>Select</option>
                                               <option value="Yes" {{$request->pmp_compliance == 'Yes' ? 'selected':''}}>Yes</option>
                                               <option value="No" {{$request->pmp_compliance == 'No' ? 'selected':''}}>No</option>
                                           </select>
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" readonly name="warranty_period_indicate"
                                               class="form-control readonly"
                                               value="{{ $request->warranty_period_indicate }}" placeholder="">
                                       </div>
                                       <div class="col-4">
                                       ...
                                       <div class="col-4">
                                           <select id="" class="form-select readonly" name="warranty_check">
                                               <option selected disabled>Select</option>
                                               <option value="Yes" {{$request->warranty_check == 'Yes' ? 'selected':''}}>Yes</option>
                                               <option value="No" {{$request->warranty_check == 'No' ? 'selected':''}}>No</option>
                                           </select>
                                       </div>
                                       ...
                                       <div class="col-md-12 col-sm-12 col-xs-12">
                                           <div class="form-check checkbox checkbox-secondary">
                                               ...
                                               <label class="form-check-label" for="flexCheckDefault">Declaration : <span
                                                       class="text-danger">*</span> We declare that the above information
                                                       relating to PM E-DRIVE certification of above said electric vehicle model is correct to the best of our
                                                       knowledge and belief. The above information is being provided to DHI/NAB
                                                       for the purpose of availing demand incentive as per guidelines of the
                                                       {{ env('APP_NAME') }}</label>
                                           </div>
                                       </div>
                                   </div>
                           ...
                           <div class="col-12 text-center">
                               <a href="{{ route('e-trucks.modelRequests.index') }}" class="btn btn-warning">Back</a>
                               <button type="submit" class="btn btn-info btn-approve btnApp">Approve</button>
               ...
               <div class="modal-content">
                   <div class="modal-body">
                       <div class="modal-toggle-wrapper">
                           <form action="{{ route('e-trucks.modelRequests.store') }}" id="formReject" role="form"
                               method="POST" class='form-horizontal modelVer prevent-multiple-submit'
