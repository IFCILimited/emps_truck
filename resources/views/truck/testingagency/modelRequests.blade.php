                                       ...
                                       <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @elseif($model->testing_flag == 'D')
                                                <td class="bg-danger"><span>Reverted</span></td>
                                            @else
                                            ...
                                            <td>{{ ($model->testing_created_at != null) ? date('d-m-Y',strtotime($model->testing_created_at)) : ''}} </td>
                                               ...
                                               <td class="text-center">
                                                @if($model->testing_flag == 'A' || $model->testing_flag == 'R')
                                                    <a href="{{route('e-trucks.modelRequests.show',encrypt($model->id))}}" class="btn btn-sm btn-success">View</a>

                                                @else
                                                    <a href="{{route('e-trucks.modelRequests.create',encrypt($model->id))}}" class="btn btn-sm btn-warning">Create</a>
                                                @endif
                                                </td>
