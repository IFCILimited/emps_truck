   ...
   @section('content')
       ...
       <div class="page-body">
           ...
           <div class="container-fluid">
               <div class="row">
                   <div class="col-sm-12">
                       <form action="{{ route('e-trucks.modelPreview') }}" id="plant" role="form" method="POST"
                    ...
                    <input type="hidden" name="oem_name" value="Tvs Motor Company Limited"> --}}
                               <div class="card-body">
                                   <div class="row g-3">
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control readonly" name="factory_price"
                                               value="{{ $model->factory_price }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control readonly" name="spec_density"
                                               value="{{ $model->spec_density }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control readonly" name="life_cyc"
                                               value="{{ $model->life_cyc }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control readonly" name="min_ex_show_price"
                                               value="{{ $model->min_ex_show_price }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                        ...
                                        value="{{ $model->testing_estimate_incentive_amount ? $model->testing_estimate_incentive_amount : $model->estimate_incentive_amount }}" name="testing_estimate_incentive_amount">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control readonly" name="range"
                                               value="{{ $model->range }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control readonly" name="max_elect_consumption"
                                               value="{{ $model->max_elect_consumption }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" name="min_max_speed" class="form-control readonly"
                                               value="{{ $model->min_max_speed }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="text" class="form-control readonly" name="min_acceleration"
                                               value="{{ $model->min_acceleration }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <select id="" class="form-select readonly"  name="meeting_tech_function">
                                               <option>Select</option>
                                               <option value="Y"
                                                   {{ $model->meeting_tech_function == 'Y' ? 'selected' : '' }}>Yes</option>
                                               <option value="N"
                                                   {{ $model->meeting_tech_function == 'N' ? 'selected' : '' }}>No</option>
                                           </select>
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <select id="" class="form-select readonly" name="meeting_qualif">
                                               <option>Select</option>
                                               <option value="Y" {{ $model->meeting_qualif == 'Y' ? 'selected' : '' }}>
                                                   Yes</option>
                                               <option value="N" {{ $model->meeting_qualif == 'N' ? 'selected' : '' }}>
                                                   No</option>
                                           </select>
                                       </div>
                                    ...
                                    <div class="col-4">
                                        <input type="text" name="certificate_no" class="form-control "
                                            placeholder="Enter Certificate Number"  @if($model->pma_revert_status == 'R') value="{{ $model->testing_certificate_no }}" @endif>
                                    </div>
                                    ...
                                    @endif
                                       ...
                                       <div class="col-4">
                                           <input type="date" name="cmvr_date" class="form-control " @if($model->pma_revert_status == 'R') value="{{ $model->testing_cmvr_date}}" @endif>
                                       </div>
                                       <!-- <div class="col-4">
                                       ...
                                       <div class="col-4">
                                           <input type="date" name="cmvr_date" class="form-control "
                                       ...
                                       <div class="col-4">
                                           <input type="date" name="approval_date" class="form-control "
                                               placeholder="Select Approval Date"  @if($model->pma_revert_status == 'R') value="{{$model->testing_approval_date}}" @endif>
                                       </div>
                                       <div class="col-4">
                                       ...
                                       <div class="col-4">
                                           <input type="date" name="valid_date" class="form-control "
                                               placeholder="Select Validate Date" @if($model->pma_revert_status == 'R') value="{{ $model->testing_valid_date }}" @endif>
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="date" name="expiry_date" class="form-control "
                                               placeholder="Select Validate Date" @if($model->pma_revert_status == 'R') value="{{ $model->testing_expiry_date }}" @endif>
                                       </div>
                                       <div class="col-4">
                                       ...
                                       <div class="col-4">
                                        <select id="" class="form-select" name="pmp_compliance">
                                            <option selected disabled>Select</option>
                                            <!-- Show Yes and No options -->
                                            <option value="Yes" {{ ($model->pma_revert_status == 'R' && $model->pmp_compliance == 'Yes') || ($model->pma_revert_status != 'R' && $model->pmp_compliance == 'Yes') ? 'selected' : '' }}>Yes</option>
                                            <option value="No" {{ ($model->pma_revert_status == 'R' && $model->pmp_compliance == 'No') || ($model->pma_revert_status != 'R' && $model->pmp_compliance == 'No') ? 'selected' : '' }}>No</option>
                                       ...
                                       <div class="col-4">
                                           <input type="text" readonly name="warranty_period_indicate"
                                               ...
                                               value="{{ $model->warranty_period_indicate }}" placeholder="">
                                       </div>
                                       <div class="col-4">
                                       ...
                                       <div class="col-4">
                                           <select id="" class="form-select" name="warranty_check">
                                               <option selected disabled>Select</option>
                                               <option value="Yes" {{ ($model->pma_revert_status == 'R' && $model->warranty_check == 'Yes') || ($model->pma_revert_status != 'R' && $model->warranty_check == 'Yes') ? 'selected' : '' }}>Yes</option>
                                               <option value="No" {{ ($model->pma_revert_status == 'R' && $model->warranty_check == 'No') || ($model->pma_revert_status != 'R' && $model->warranty_check == 'No') ? 'selected' : '' }}>No</option>
                                           </select>
                                       </div>
                           ...
                           <div class="col-12 text-center">
                               ...
                               <button type="submit" class="btn btn-success btn-approve btnApp">Preview</button>
   ...
   @push('scripts')
       ...
       <script>
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'The following model parameters entered by OEM vary with that entered by Test Agency. Please re-check and rectify if needed . Ensure that parameters entered by Test Agency and OEM are exactly as per the model certificate submitted for approval.',
            icon: 'warning',
