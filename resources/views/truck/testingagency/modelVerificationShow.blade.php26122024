                    ...
                    <input type="hidden" name="oem_name" value="Tvs Motor Company Limited"> --}}
                               <div class="card-body">
                                   <div class="row g-3">
                                       ...
                                       <div class="col-4">
                                           <input type="text" readonly class="form-control readonly" name="factory_price"
                                       ...
                                       <div class="col-4">
                                           <input type="text" readonly class="form-control readonly" name="spec_density"
                                       ...
                                       <div class="col-4">
                                           <input type="text" readonly class="form-control readonly" name="life_cyc"
                                       ...
                                       <div class="col-4">
                                           <input type="text" readonly class="form-control readonly" name="range"
                                       ...
                                       <div class="col-4">
                                           <input type="text" readonly name="min_max_speed"
                                               class=" readonly form-control" value="{{ $model->testing_min_max_speed }}">
                                       </div>
                                       ...
                                       <div class="col-4">
                                           <input type="date" readonly class="form-control readonly"
                                     ...
                                     <div class="col-4">
                                       ...
                                       <div class="col-md-12 col-sm-12 col-xs-12">
                                           <div class="form-check">
                                               ...
                                               <label class="form-check-label" for="flexCheckDefault">Declaration :* We
                                                   declare that the above information relating to vehicle testing report is
                                                   correct to the best of our knowledge and belief. The above information is
                                                   being provided to DHI/NAB for the purpose of availing demand incentive as
                                                   per guidelines of the {{ env('APP_NAME')}}.</label>
                                           </div>
                                       </div>
