                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input class="form-control" type="hidden"
                                                            value="{{ $utype }}" readonly name="usertype">
                                                        <input class="form-control" type="hidden"
                                                            value="{{ $utype }}" readonly name="usertype">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control @error('username') is-invalid @enderror"
                                                            type="text" name="identity" id="identity" required=""
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <div class="text-end mt-3">
                                                            <button class="btn btn-primary btn-block w-100" id="signin-btn"
                                                                type="submit" style="border-radius: 20px;">Sign in</button>
                                                        </div>
                                                    </div>
