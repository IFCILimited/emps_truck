                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="navigation">
                                <div class="logo">
                                    <a href="/">
                                        <img src="{{ asset('assets/images/MHI-logo.png') }}"
                                            class="img-fluid image-fit" style="width: 100%; " alt="Logo">
                                    </a>
                                </div>
                                <div class="main-menu">
                                    ...
                                    <nav>
                                        <ul class="custom">
                                            ...
                                            <li class="menu-item menu-item-has-children"> <a href="#"
                                                    class="text-custom-black">About Us</a>
                                                <ul class="custom sub-menu">
                                                    <li class="menu-item"> <a href="{{ route('about-us') }}"
                                                            class="text-light-grey">Brief</a>
                                                    </li>
                                                    <li class="menu-item"> <a href="{{ route('who') }}"
                                                            class="text-light-grey">Who's who</a>
                                                    </li>
                                                </ul>
                                            </li>

                                            <li class="menu-item menu-item-has-children">
                                                <a href="#" class="text-custom-black">Scheme</a>
                                                <ul class="custom sub-menu">
                                                    <li class="menu-item">
                                                        <a href="{{ route('policy_document') }}" class="text-light-grey">Notifications</a>
                                                    </li>
                                                    <li class="menu-item menu-item-has-children">
                                                        <a href="{{ route('policy_document') }}" class="text-light-grey">Guidelines</a>
                                                        <ul class="custom sub-menu">
                                                            <li class="menu-item">
                                                                <a href="{{ route('policy_procedure') }}" class="text-light-grey">Operational Guidelines</a>
                                                            </li>
                                                            <li class="menu-item">
                                                                <a href="{{ route('draftPMPGuidelines') }}" class="text-light-grey">Draft PMP Guidelines</a>
                                                            </li>
                                                            <li class="menu-item">
                                                                <a href="{{ route('EVPCSGuidelines') }}" class="text-light-grey">Draft EVPCS Guidelines</a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="{{ route('models') }}" class="text-light-grey">Models</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            
                                            <li class="menu-item   menu-item-has-children"> <a href="#"
                                                    class="text-custom-black">Announcements</a>
                                                <ul class="custom sub-menu">
                                                    <li class="menu-item"> <a href="{{ route('press_release') }}"
                                                            class="text-light-grey">Press Release</a>
                                                    </li>
                                                    {{-- <li class="menu-item"> <a href="{{ route('Claim_submission') }}" class="text-light-grey">Claim submission</a>
                                                    </li> --}}

<li class="menu-item">
                                                        <a href="{{ asset('docs/Letter no. 12(74)2024-AEI(30030) dated 08 11 2024.pdf') }}"
                                                        class="text-light-grey" target="_blank">Intimation for e-3W (L5)</a>
                                                    </li>

                                                </ul>
                                            </li>
                                            <li class="menu-item  "> <a href="{{ route('impotrant-links') }}"
                                                    class="text-custom-black">Important Links</a>
                                            </li>
                                            <li class="menu-item   menu-item-has-children"> <a href="#"
                                                    class="text-custom-black">Contact Us</a>
                                                <ul class="custom sub-menu">
                                                    <li class="menu-item"> <a href="{{ route('support') }}"
                                                            class="text-light-grey">Support</a>
                                                    </li>
                                                    <li class="menu-item"> <a href="{{ route('contact-us') }}"
                                                            class="text-light-grey">Contact Detail</a>
                                                        {{-- <li class="menu-item"> <a href="{{ route('FAQs') }}" class="text-light-grey">FAQ's</a>
                                                    </li> --}}

			<li class="menu-item"> <a href="{{ asset('docs/FAQ Error Handling.pdf') }}" class="text-light-grey" target="_blank">FAQ Error Handling</a></li>
                                                </ul>
                                            </li>
                                           <li class="menu-item"> <a href="{{ route('dashboard-home') }}"
                                                    class="text-custom-black">Dashboard</a>
                                            </li>
                                        </ul>
                                    </nav>
                                    <div class="right-side">
                                        ...
                                        <div class="cta-btn">
                                            @auth
                                                <a href="{{ route('dashboard') }}"
                                                    class="btn btn-sm dropdown-toggle btn-login">
                                                    Dashboard-</a>
                                            @else
                                                <button class="btn-first btn-submit dropdown-toggle" type="button"
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <div class="dropdown-submenu">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ route('signin', encrypt(1)) }}">MHI</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('signin', encrypt(10)) }}">MHI AS</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('signin', encrypt(11)) }}">MHI DS</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('signin', encrypt(12)) }}">MHI View
                                                                Only</a>
                                                        </div>
                                                    </div>
                                                    <div class="dropdown-submenu">
                                                    ...
                                                    {{-- <a class="dropdown-item"
                                                        href="{{ route('signin', encrypt(2)) }}">OEM</a> --}}
                                                    {{-- <a class="dropdown-item"
                                                        href="{{ route('signin', encrypt(3)) }}">Dealers</a> --}}
                                                    <a class="dropdown-item"
                                                        href="{{ route('signin', encrypt(4)) }}">Testing Agency</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('signin', encrypt(5)) }}">PMA</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('signin', encrypt(6)) }}">Auditor</a>
        ...
        <footer class="bg-black section-padding footer">
            {{-- <div class="overlay" style=" background: #000;  opacity: 0.5;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="footer-box mb-md-80">
                            ...
                            <ul class="custom links" style="column-count: 2;">
                                ...
                                <li> <a href="{{ route('impotrant-links') }}" class="text-custom-white">Important
                                        Links</a>
                                </li>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12">
                        <div class="footer-box footer-developed-By">
                            <div class="footer-heading mt-60">
                                <h4 class="mt-3 text-left text-custom-white">Portal Designed and Developed By <a
                                        href="https://www.ifciltd.com/?q=en/content/what-we-are" target="_blank"> IFCI
                                        Ltd.</a></h4>
                            </div>
        ...
        <div class="copyright">
            <div class="container">
                <div class="row">
                    ...
                    <!-- <div class="col-lg-12">
                        <p class="text-custom-white no-margin text-center">Copyright &#169; 2024 Ministry of Heavy
                            Industries, Government of India. All rights reserved.</a>
                        </p>
                    </div> -->
                    <div class="col-lg-10">
                        <p class="text-custom-white no-margin text-center">Copyright &#169; 2024 Ministry of Heavy
                    ...
                    <div class="col-lg-2">
                        <h5 class="text-left text-custom-white">Total Visitors : {{  DB::table('counters')->first()->count }}
