                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Oem has successfully submitted the Post registration form for approval.
                                </h5>
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p><b>{{$user->name}}</b> (OEM) successfully submitted the Post registration form for approval.</p>
                                    </td>
                                </tr>
