...
<head>
    ...
    <title>{{ env('APP_NAME')}} Portal - Pre-registration Process Initiated</title>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Oem has successfully submitted the pre registration form
                                </h5>
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>
                                          {{$user->name }} has successfully submitted
                                            the Pre-Registration Form for approval/rejection under  {{ env('APP_NAME')}}.
