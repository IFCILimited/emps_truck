...
<head>
    ...
    <title>{{ env('APP_NAME')}} Portal - Model Rejected by Testing Agency</title>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Model Rejected by Testing Agency.
                                </h5>
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>
                                            Testing Agency has rejected your model ({{ $model->model_name }}) with remarks "{{ $model->testing_remarks }}".
                                        </p>
                                    </td>
                                </tr>
