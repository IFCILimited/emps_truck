...
<head>
    ...
    <title>{{ env('APP_NAME')}} Portal - Model Submitted by OEM</title>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Model Submitted by OEM.
                                </h5>
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>
                                            {{$detail->name }} (OEM) has successfully submitted 
                                            @if ($model->category_type == 'O')
                                            "NEW"
                                            ...
                                            "Revised"
                                            @endif
                                            model ({{ $model->model_name }}) for approval.
                                    </td>
                                </tr>
