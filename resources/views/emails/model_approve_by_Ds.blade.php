...
<head>
    ...
    <title>{{ env('APP_NAME')}} Portal -Model Approved by MHI</title>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Model Approved by MHI
                                </h5>
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>
                                            Your model({{ $model->model_name }}) has been approved by MHI.Model details
                                            are as below -
