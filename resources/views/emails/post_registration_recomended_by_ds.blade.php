...
<head>
    ...
    <title>{{ env('APP_NAME')}} Portal - Post Registration Recommeded</title>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Post Registration Recommeded.
                                </h5>
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>
                                            {{$user->name}} (DS MHI) has recommeded for approval/rejection.
                                        </p>
                                    </td>
                                </tr>
