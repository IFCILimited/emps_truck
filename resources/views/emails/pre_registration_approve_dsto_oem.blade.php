                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Your registration process has been initiated.
                                </h5>
                            </p>
                        </td>
                    </tr>
                        ...
                        <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    @endphp
                                    @if($user->approval_for_post_reg == 'A')
                                    <td
                                        style="padding: 20px 0 30px 0; color: #153643; font-family: arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        <p>Your account has been approved. You can now proceed with registration.
                                        </p>
                                        <a href="{{ URL::to('post_registration/' . encrypt($user->id)) }}" target="_blank">Register Now</a>
                                    </td>
                                    @elseif($user->approval_for_post_reg == 'R')
                                    <td
                                        style="padding: 20px 0 30px 0; color: #153643; font-family: arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        <p>Account Rejected
                                            <br>
