...
<head>
    ...
    <title>{{ env('APP_NAME')}} Portal - Model Rejected by MHI</title>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" bgcolor="#70bbd9"
                            ...
                            <p>
                                <h5 style="color:rgb(168, 39, 39);">Model Rejected by MHI.
                                </h5>
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #153643; font-family: arial, sans-serif; font-size: 24px;">
                                        {{-- <b>{{ $user->name }}!</b> --}}
                                         <p>Dear Sir/Ma'am <br><b>{{$detail->name }}</b></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td
                                        ...
                                        <p>
                                            Your model({{ $model->model_name }}) has been rejected by MHI with remarks "{{$rem}}". Model details
                                            are as below -
                                    ...
                                    <table align="center" border="30" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 10px; text-align: right;">{{ $model->ex_factory_price }}</td>
