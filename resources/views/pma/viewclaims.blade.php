                                   ...
                                   <table class="display table-bordered  table-striped" id="export-button">
                                      ...
                                      @foreach($claims as $claim)
                                        ...
                                        @if($claim->custmr_typ == 1)
                                            <a href="{{route('ackdoc.finalview', $claim->id)}}" class="btn btn-success">View</a>
                                        @else
                                         <a href="{{route('buyerdetail.vin.manage_invoice_preview', [$claim->id, encrypt($claim->mbdId)])}}" class="btn btn-success">View</a>
                                        @endif
                                            </td>
                                        </tr>
                                    @endforeach
