            ...
            <div class="row">
                <span class="pull-right">
                    <button class="btn btn-primary" type="button">
                        <a href="{{ route('manageOperator.create') }}" class="text-light" style="text-decoration: none;"><i class="fa fa-user"></i>  Add Operator</a>
                    </button>
                                            ...
                                            <tr>
                                                        ...
                                                        @if($dealerRegs->isactive == 'Y' && $dealerRegs->isapproved == 'Y')
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                   ...
                                                                   onclick="confirmAction('{{ route('updateOperator.update', encrypt($dealerRegs->id)) }}', 'deactivate')">
                                                                   Login Activate
                                                                </a>
                                                            </li>
                                                        @elseif($dealerRegs->isactive == 'N' && $dealerRegs->isapproved == 'N')
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                   ...
                                                                   onclick="confirmAction('{{ route('updateOperator.update', encrypt($dealerRegs->id)) }}', 'activate')">
                                                                   Login Deactivate
                                                                </a>
                                                            </li>
                                                        @endif
                                                ...
                                                <td>
                                                    <ul class="action">
                                                        @if($dealerRegs->isactive == 'Y' && $dealerRegs->isapproved == 'Y')
                                                            <!-- Deactivate Button -->
                                                            <li><a href="{{ route('manageOperator.edit', encrypt($dealerRegs->id)) }}" class="btn btn-sm btn-warning">Edit</a></li>&nbsp;
                                                            <li><a href="{{ route('manageDealer.resendMail', encrypt($dealerRegs->id)) }}" class="btn btn-sm btn-success">Resend Mail</a></li>
                                                        @elseif($dealerRegs->isactive == 'N' && $dealerRegs->isapproved == 'N')
                                                            <!-- Activate Button -->
