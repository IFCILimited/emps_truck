                            ...
                            <div style="display: flex;align-items: center;justify-content: space-between;">
                                <div style="display: flex;align-items: center;">
                                    ...
                                    <div style="margin-left: 10px">
                                        <form action="{{route("buyerdetail.index")}}" method="get" style="display: flex">
                                            @csrf
                                            ...
                                            <a href="{{route("buyerdetail.index")}}" class="btn btn-info" style="margin-left: 1rem;">Refresh</a>
                                        </form>

                                    </div>
                                </div>
                                <div>
                                    <a href="{{ route('buyerdetail.create') }}" class="btn btn-success" style="float: right;">Add Buyer Detail</a>
                                </div>
                            </div>
                           </div>
                           <div class="card-body">
