                           ...
                           <div class="card-header pb-0 card-no-border">
                            <div style="display: flex;align-items: center;justify-content: space-between;">
                                <div style="display: flex;align-items: center;">
                                    <form action="{{route("multibuyerdetail.export_data")}}" method="post">
                                        @csrf
                                        <button class="btn btn-sm btn-primary" type="submit">Export CSV</button>
                                    </form>

                                    <div style="margin-left: 10px">
                                        <form action="{{route("buyerdetail.multi_buyers")}}" method="get" style="display: flex">
                                            @csrf
                                            ...
                                            <a href="{{route("buyerdetail.multi_buyers")}}" class="btn btn-info" style="margin-left: 1rem;">Refresh</a>
                                        </form>
