...
@section('content')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a style="width: 35%;float: right;" id="e_voucher_div" target="_blank"
                                                href="{{ route('dealer.multiBuyerVoucher', encrypt($bankDetail->id)) }}"
    ...
    @endif -->
                ...
                <div style="display: flex;justify-content: space-evenly;align-items: center;">
                    <div class="text-left">
                        <a href="{{ route('buyerdetail.multi_detail_edit', encrypt($rowId)) }}"
            ...
            @if (
                ...
                <div class="text-end">
                    <form id="final_submit_form" action="{{ route('buyerdetail.multi_invoice_submit') }}"
                        method="post">
                        @csrf
