               ...
               <div class="row">
                   ...
                   <div class="col-sm-12">
                    ...
                    <input type="hidden" name="oem_name" value="Tvs Motor Company Limited"> --}}
                                   ...
                                   <div class="row g-3">
                                       ...
                                       <div class="col-4">
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly class="form-control readonly" value="{{$model->name}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                             <h5>{{$model->segment_id}}</h5>
                                         </div>
                                         <div class="col-4">
                                             <select name="" id="" class="form-select" disabled>
                                                 <option>Select</option>
                                                 <option value="{{$model->segment_id}}"  selected>{{$model->segment_id}}</option>
                                             </select>
                                         </div>
                                        ...
                                        <div class="col-4">
                                             <h5>{{$model->vehicle_cat_id}}</h5>
                                         </div>
                                         <div class="col-4">
                                             <select name="" id="" class="form-select" disabled>
                                                 <option>Select</option>
                                                 <option value="{{$model->vehicle_cat_id}}"  selected>{{$model->vehicle_cat_id}}</option>
                                             </select>
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                             <select name="" id="" class="form-select" disabled>
                                                 <option>Select</option>
                                                 <option value="{{$model->tech_type}}"  selected>{{$model->tech_type}}</option>
                                             </select>
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly class="form-control readonly" name="factory_price" value="{{$model->factory_price}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly class="form-control readonly" name="spec_density" value="{{$model->spec_density}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly class="form-control readonly" name="life_cyc" value="{{$model->life_cyc}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                             <select name="" id="" class="form-select" disabled>
                                                 <option>Select</option>
                                                 <option value="{{$model->no_of_battery}}"  selected>{{$model->no_of_battery}}</option>
                                             </select>
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly class="form-control readonly" name="min_ex_show_price" value="{{$model->min_ex_show_price}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <select name="" id="" class="form-select" disabled>
                                                <option>Select</option>
                                                <option value="{{$model->monitoring_device_fitment}}"  selected>{{$model->monitoring_device_fitment}}</option>
                                            </select>
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly class="form-control readonly" name="range" value="{{$model->range}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly class="form-control readonly" name="max_elect_consumption" value="{{$model->max_elect_consumption}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly name="min_max_speed" class=" readonly form-control" value="{{$model->min_max_speed}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="text" readonly class="form-control readonly" name="min_acceleration" value="{{$model->min_acceleration}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <select id="" class="form-select" name="meeting_tech_function" disabled>
                                                <option>Select</option>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <select  id="" class="form-select" name="meeting_qualif" disabled>
                                                <option>Select</option>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="date" readonly class="form-control readonly" name="vehicle_sub_to_test_agency_apprv" value="{{$model->vehicle_sub_to_test_agency_apprv}}">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="file" readonly name="certificate" class="readonly form-control" >
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="date" name="approval_date" readonly class="form-control readonly" value="{{$model->testing_approval_date}}" placeholder="Select Approval Date">
                                         </div>
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <input type="date" name="expiry_date" readonly class="form-control readonly" value="{{$model->testing_expiry_date}}" placeholder="Select Validate Date">
                                         </div>
                                        ...
                                        @if($model->mhi_flag == 'A' || $model->mhi_flag == 'R')
                                        <div class="col-12 text-center">
                                            @if($model->mhi_flag == 'A')
                                                <input type="text" value="Approved" readonly class="readonly form-control"> 
                                            @elseif($model->mhi_flag == 'R')     
                                                <input type="text" value="Rejected" readonly class="readonly form-control">
                                            @endif
                                        </div>
                                        @endif
                                   </div>
                               ...
                               <input type="hidden" name="oem_name" value="{{$model->name}}">
