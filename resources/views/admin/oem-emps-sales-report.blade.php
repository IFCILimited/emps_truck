        ...
        <div class="container-fluid">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1>OEM wise month wise sales as per EMPS</h1>
                </div>
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <form method="GET" action="{{ route('OEM-emps-Sales-Report') }}">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2 mt-4">
                                        <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('OEM-emps-Sales-Report') }}';">
                                            Reset
                                        </button>
                                    </div>
