                                        ...
                                        <div class="dt-ext table-responsive custom-scrollbar">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Segment:</th>
                                                        <td>@if(count($toViewSegment) == 2) e-2w @else e-3w @endif</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Category:</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($details as $det)
                                                        <tr>
                                                            ...
                                                            <td 
                                                                {{-- class="@if ($det->adh_verify == 'N') bg-danger @else 
                                                                 @if ($det->status=='D')
                                                                        bg-warning
                                                                    @elseif($det->status=='S')
                                                                        bg-primary
                                                            ...
                                                            <td 
                                                                {{-- class="@if(isset($det->vhcl_regis_no) || isset($det->temp_reg_no)) bg-success @else bg-danger @endif" --}}
                                                                >
                                                            ...
                                                            <td 
                                                            {{-- class="@if($det->evoucher_copy_id) bg-success @else bg-danger @endif" --}}
                                                            >
