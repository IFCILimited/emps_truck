                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            ...
                                            <span class="text-danger">(Please also upload earlier certificate in a single
                                                file.)</span>
                                        </div>
                                        <div class="col-4">
                                        </div>
                                        ...
                                        <div class="col-4">
                                                <input type="text" name="certificate_no" value="{{$model->cmvr_certificate_date_new}}" readonly class="form-control readonly">
                                        </div>
                                         <div class="col-4">
                                        ...
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <p><b>{{ env('APP_NAME')}} Compliance Certificate valid Form:*</b></p>
                                        </div>
                                        <div class="col-4">
                                         ...
                                         <div class="col-4">
                                            <p><b>{{ env('APP_NAME')}} Compliance Certificate Validate Upto:*</b></p>
                                        </div>
                                        <div class="col-4">
