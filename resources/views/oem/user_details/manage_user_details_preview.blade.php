    ...
    <div class="page-body">
        <div class="container">
            <div class="col-xl-12 mt-3">
                <form action="{{route('manageCompanyDetails.update', $details->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            {{-- @if(!$details->pma_status) --}}
                                <div class="col-12 d-flex justify-content-between">
                                    ...
                                    <a class="btn btn-info" href="{{route('manageCompanyDetails.index')}}">Back</a>
                                </div>
                            {{-- @else --}}
                            ...
                            <div class="col-12">
                                ...
                                @endif
                                <a class="btn btn-info mt-2" href="{{route('manageCompanyDetails.index')}}">Back</a>
                            </div>
                            @endif
                        </div>
                    </div>
    ...
    <div class="modal fade" id="confirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="updateForm" action="{{ route('manageCompanyDetails.submitToPma') }}" method="post" enctype="multipart/form-data">
                    @csrf
