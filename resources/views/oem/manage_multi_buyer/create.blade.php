            ...
            <form action="{{ route('buyerdetail.multi_update', $bankDetail->id) }}" role="form" method="POST"
                                    ...
                                    <table class="table table-stripped table-bordered" id="multiVinTable">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('buyerdetail.manage_invoice_preview', [$bd_id, encrypt($rowId), 'edit', 'oem']) }}" class="btn btn-info">View</a>
                                            </td>
                ...
                <div class="col-12 d-flex justify-content-center align-items-center">
                    <div style="margin-left: 1rem;">
                        <a type="button" class="btn btn-info" href="{{ route('manageBulkBuyerDetails.index', 'P') }}" class="btn btn-warning">Back</a>
                    </div>
                    <div style="margin-left: 1rem;">
        ...
        <div class="modal fade" id="confirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="updateForm" action="{{ route('manageBulkBuyerDetails.action', encrypt($rowId)) }}" method="post">
                        @csrf
                        @method('PUT')
