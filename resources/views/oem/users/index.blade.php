            ...
            <div class="row">
                <span class="pull-right">
                    <button class="btn btn-primary" type="button">
                        <a href="{{ route('manageUser.create') }}" class="text-light" style="text-decoration: none;"><i class="fa fa-user"></i>  Add User</a>
                    </button>
                </span>
                &nbsp;
                <div class="col-sm-12">
                                    ...
                                    <tbody>
                                        @foreach ($users as $key => $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="action">
                                                        <li class=""><a href="{{ route('manageUser.edit', encrypt($user->id)) }}" class="btn btn-sm btn-warning">Edit</a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        @endforeach
