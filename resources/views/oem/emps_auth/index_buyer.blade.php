                                   ...
                                   <table class="display table-bordered  table-striped" id="export-button">
                                       ...
                                       <tbody>
                                        ...
                                        @if($status == 'A' || $status == 'P')
                                            ...
                                            <a href="{{route('Empsbuyer.cerate', encrypt($bankDetail->id))}}" class="btn btn-primary">View</a>
                                            @elseif($bankDetail->pmedrive_dealer_status == 'S')
                                                <a href="{{route('Empsbuyer.cerate', encrypt($bankDetail->id))}}" class="btn btn-success">Create</a>
                                            @endif
                                            </td>
                                        @elseif($status == 'R')
