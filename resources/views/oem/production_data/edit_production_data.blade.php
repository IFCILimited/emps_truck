                            ...
                            <form action="{{ route('manageProductionData.update', Auth::user()->id) }}" id="editProd"
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-md-5 d-flex justify-content-center">
                                        ...
                                        <a href="" class="btn btn-danger btn-sm me-2" onclick="event.preventDefault(); confirmDelete('{{ route('manageProductionData.deleteTempData', ['id' => $productionData[0]->model_master_id, 'status' => '2']) }}')">Delete</a>
                                    </div>
                                    <div class="col-md-4 d-flex justify-content-end">
                                        <a class="btn btn-primary btn-sm"
                                           href="{{ route('productionData.finalSubmit', ['id' => Auth::user()->id]) }}">
                                            Final Submit
                                        </a>
                                    </div>
                                </div>
