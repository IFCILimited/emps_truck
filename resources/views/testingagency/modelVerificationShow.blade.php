           ...
           <div class="container-fluid">
               <div class="row">
                <div class="col-12 p-10">
                   ...
                   <div class="col-sm-12">
                       <form action="{{ route('manageOEMApproval.store') }}" id="plant" role="form" method="POST"
...
{{--
          ...
          <div class="modal-content">
            <div class="modal-body">
              <div class="modal-toggle-wrapper"> 
                <form action="{{route('manageOEMApproval.store')}}"  id="formApprove" role="form" method="POST"
       ...
       <div class="modal-dialog" role="document">
           <div class="modal-content">
               <div class="modal-body">
                   <div class="modal-toggle-wrapper">
                       <form action="{{ route('modelRevert') }}" id="formReject" role="form"
   ...
   <div class="modal fade" id="revertMHI" tabindex="-1" role="dialog" aria-labelledby="revert"
       ...
       <div class="modal-dialog" role="document">
           <div class="modal-content">
               <div class="modal-body">
                   <div class="modal-toggle-wrapper">
                       <form action="{{ route('modelRevertMHI') }}" id="formReject" role="form"
                           method="POST" class='form-horizontal modelVer' accept-charset="utf-8"
                           enctype='multipart/form-data' files=true>
                           @csrf
       ...
       <div class="modal fade" id="reject" tabindex="-1" role="dialog" aria-labelledby="reject"
           ...
           <div class="modal-dialog" role="document">
               <div class="modal-content">
                   <div class="modal-body">
                       <div class="modal-toggle-wrapper">
                           <form action="{{ route('manageOEMApproval.store') }}" id="formReject" role="form"
                               method="POST" class='form-horizontal modelVer' accept-charset="utf-8"
                               enctype='multipart/form-data' files=true>
                               @csrf
