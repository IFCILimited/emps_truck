...
@push('scripts')
	...
	$('.close_ticker').on('click', function(){
            ...
            <div class="transform-center home-slider">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        {{-- 14-02-2025 by Azhar  --}}
                     {{--   <div class="col-lg-4 col-md-4 justify-content-center align-items-center">
                            <span class="marquee-text">PM E-DRIVE portal shall not be available on Monday <span class="text-black">(17-02-2025)</span> from 6:30 AM to 10:30 AM, due to scheduled maintenance.</span>
                        </div> --}}
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 544px;">
            <div class="modal-content">
                <div class="modal-header" style="padding: 0.6rem 0.7rem;background: #6bcfe6e5;">
                    ...
                    <button type="button" class="close close_ticker"  data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
 
                <div class="modal-body">
                    <p>Demand incentive @ ₹2,500 per kWh is applicable for e-2W and e-3W ( e- rickshaw and e-cart ) registered on and after April 1, 2025.</p>
                </div>
 
                <div class="modal-footer" style="background: #6bcfe6e5;padding: 0.6rem 0.7rem;">
                    <button type="button" class="btn btn-danger close_ticker" data-dismiss="modal" style="background: #fb9439;border: none;">Close</button>
                  </div>
            </div>
