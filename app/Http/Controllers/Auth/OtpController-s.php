...
class OtpController extends Controller
{
    ...
    public function verifyLoginOTP(OtpRequest $request)
    {
        ...
        if ($userId == "" || $userId == null) {
            ...
            if ($OTP === $enteredOtp) {
                ...
                //     return redirect()->route('TestingAgency.index');
    ...
    public function formOTP($email,$mobile)
    {
      ...
      //      $msg = 'One Time Password(OTP) for Mobile Verification: ' . $otp . '. Do not share this OTP with anyone!';
//dd( $msg);
            $smsResponse = sendSMSAPI($mobile,$msg);
//dd($otp, $mobile, $smsResponse );
