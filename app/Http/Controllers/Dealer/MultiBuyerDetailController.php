...
class MultiBuyerDetailController extends Controller
{
    public function index()
    {
        try {
            ...
            return view('buyer.bulkbuyer.multi_buyer_index', compact('dealerDetails', 'custId'));
        } catch (Exception $e) {
            // dd($e->getMessage());
    ...
    public function multiCreate()
    {
        try {
            ...
            return view('buyer.bulkbuyer.create_multiple_2', compact('user', 'type', 'oemname', 'minDate', 'maxDate'));
    ...
    public function multiEdit($id)
    {
        ...
        try {
            ...
            $maxDate = '2026-03-31';
            // dd($multiBuyerDetail);
            return view('buyer.bulkbuyer.buyer_multi_edit', compact('bankDetail', 'productionDetails', 'user', 'id', 'type', 'oemname', 'minDate', 'maxDate', 'vins', 'rowId', 'multiBuyerDetail'));
        } catch (Exception $e) {
            // dd($e->getMessage());
            alert()->error('Oops!', 'Something went wrong!')->persistent('Close');
            // errorMail($e, Auth::user()->id);
    ...
    ini_set('max_execution_time', 7600);
        try {
            ...
            return view('buyer.bulkbuyer.buyer_multi_invoice_preview', compact('userType', 'bankDetail', 'prodDet', 'user', 'id', 'type', 'oemname', 'minDate', 'maxDate', 'rowId', 'flag'));
    ...
    public function manageInvoice($id, $rowId)
    {
        try {
            ...
            return view('buyer.bulkbuyer.buyer_multi_invoice', compact('bankDetail', 'prodDet', 'user', 'id', 'type', 'oemname', 'minDate', 'maxDate', 'rowId'));
    ...
    public function managePreview($id, $userType)
    {
        try {
            ...
            return view('buyer.bulkbuyer.buyer_multi_edit_preview', compact('userType', 'bankDetail', 'productionDetails', 'user', 'id', 'type', 'oemname', 'minDate', 'maxDate', 'vins', 'rowId', 'multiBuyerDetail'));
        } catch (Exception $e) {
            // dd($e->getMessage());
            alert()->error('Oops!', 'Something went wrong!')->persistent('Close');
            // errorMail($e, Auth::user()->id);
    ...
    public function BulkOemReturn(Request $request)
    {
        try {
            ...
            return view('buyer.bulkbuyer.multi_return_by_oem', compact('dealerDetails', 'custId'));
        } catch (Exception $e) {
            // dd($e->getMessage());
            alert()->error('Oops!', 'Something went wrong!')->persistent('Close');
            // dd($e->getMessage());
...
public function mangeVinWiseInvoicePreview($id, $rowId)
    {
        try {
            ...
            return view('buyer.bulkbuyer.buyer_multi_vin_invoice_preview', compact( 'bankDetail', 'prodDet', 'user', 'id', 'type', 'oemname', 'rowId', 'multiBuyerDetail'));
