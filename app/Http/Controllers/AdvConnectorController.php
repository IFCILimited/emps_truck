...
class AdvConnectorController extends Controller
{
    ...
    public function storeAadharNumber(Request $request) {
        ...
        \Log::error('Error while ADV tokenization : '.json_encode($curlResponse["message"]));
    ...
    public function fetchAadharNumber(Request $request) {
        ...
        return response()->json(['status' => 0,'message' => 'Error while detokenizing aadhar number', 'details' => $curlResponse], 500);
    }
