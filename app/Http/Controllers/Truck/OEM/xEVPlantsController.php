...
class xEVPlantsController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('truck.oem.ev_plant_detail.manufacturing_xEV_plants', compact('plants'));
        } catch (\Exception $e) {
    ...
    {
        try {
            return view('truck.oem.ev_plant_detail.xEV_plant_create');
        } catch (\Exception $e) {
            errorMail($e, Auth::user()->id);
            return redirect()->back();
        }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('e-trucks.xEVPlants.index');
        } catch (\Exception $e) {
            errorMail($e, Auth::user()->id);
            return redirect()->back();
        }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('truck.oem.ev_plant_detail.xEV_plant_edit', compact('plant'));
        } catch (\Exception $e) {
            errorMail($e, Auth::user()->id);
            return redirect()->back();
        }
