...
namespace App\Http\Controllers\Truck\TestingAgency;
...
class ModelRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $models = DB::table("truck_model_master as mm")
                ...
                ->get();
            //  dd($models);
            return view('truck.testingagency.modelRequests', compact('models'));
        } catch (\Exception $e) {
            // dd($e);
    ...
    public function modelPreview(Request $request)
    {
        ...
        try {
            ...
            $testing_agency_name = Auth::user()->name;
            // dd($model);
            return view('truck.testingagency.modelPreview', compact('model', 'testing_agency_name', 'request', 'modelDoc_id', 'cmvrid', 'assessment_id'));
        } catch (\Exception $e) {
            // errorMail($e, Auth::user()->id);
            // dd($e);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('e-trucks.modelRequests.index');
        } catch (\Exception $e) {
            // dd($e);
            return redirect()->back();
        }
