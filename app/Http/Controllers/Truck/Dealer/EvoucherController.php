...
class EvoucherController extends Controller
{
    ...
    {
        return view('truck.buyer.e_voucher_search');
    }
     ...
     */
        public function store(Request $request)
        {
            ...
            if (!is_numeric($request->buyer_id)) {
                // Return or respond with an error code or message
            ...
            if ($request->has('buyer_id')) {
                ...
                if(!$customerDetails) {
                return redirect()->back()->with('alert', 'No details found')->with('alert_type', 'error');
                }
            ...
            return view('truck.buyer.e_voucher_search', compact('customerDetails'));
        }
