...
class EmpsAuthController extends Controller
{
    ...
    {
        $pid = getParentId();
        return view('truck.buyer.empsAuth.create_buyer');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('vin_chassis_no')) {
            ...
            if (!empty($empsAuthBuyer)) {
                ...
                return view('truck.buyer.empsAuth.create_buyer', compact('customerDetails'));
            }
        }
    ...
    public function show_detail($id)
    {
        ...
        return view('truck.buyer.empsAuth.generate_buyer', compact('bankDetail', 'cat', 'BuyerId'));
    }
    ...
    public function emps_auth(Request $req)
    {
        ...
        return view('truck.buyer.empsAuth.auth_index', compact('empsAuthBuyer'));
    }
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view('truck.buyer.empsAuth.edit_buyer', compact('bankDetail', 'user', 'customerId', 'cat','type'));
        } catch (Exception $e) {
            alert()->error('Something went wrong. Please try again.', 'Error')->persistent('Close');
            return redirect()->back();
        }
        ...
        // return view('truck.buyer.empsAuth.edit_buyer');
    }
