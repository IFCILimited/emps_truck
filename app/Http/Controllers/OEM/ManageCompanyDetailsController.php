...
class ManageCompanyDetailsController extends Controller
{
    ...
    public function index()
    {
        ...
        $details = $data->get();
        return view('oem.user_details.manage_user_details_list', compact('details'));
    ...
    public function create()
    {
        ...
        return view('oem.user_details.manage_user_details', compact('usersDetails', 'docs'));
    }
    ...
    public function store(Request $request)
    {
        try{
            ...
            return redirect()->route('manageCompanyDetails.index');
        }catch(\Exception $ex){
            // dd($ex->getMessage());
    ...
    public function show($id)
    {
        try{
            ...
            if($details->status == 'S') {
                //go into preview
                return view('oem.user_details.manage_user_details_preview', compact('details', 'docs'));
            }
            return view('oem.user_details.manage_user_details_edit', compact('details', 'docs'));
        }catch(\Exception $ex){
            // dd($ex->getMessage());
            // errorMail($e, Auth::user()->id);
            alert()->error('Something went wrong!', 'Error')->persistent('Close');
