...
class BankDetailController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('oem.bank_detail.bankDetails', compact('bankDetail', 'tempBankDetail'));
        } catch (\Exception $e) {
        ...
        try {
            DB::transaction(function () use ($request) {
                ...
                $bankdetail->save();
                    ...
                    return redirect()->route('bankDetails.index')->with('success', 'No bank check was performed.');
                }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('oem.bank_detail.bankDetailsEdit', compact('bankDetail'));
        } catch (\Exception $e) {
            errorMail($e, Auth::user()->id);
            return redirect()->back();
        }
