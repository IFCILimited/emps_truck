...
//             return view("oem.production_data.index_production_data", compact('productionData', 'modelMaster'));
            ...
            return view("oem.production_data.index_production_data", compact('modelMaster'));
        } catch (\Exception $e) {
            errorMail($e, $pid);
...
->get();
            ...
            return view('oem.production_data.create_production_data', compact('items','modelMaster'));
        } catch (\Exception $e) {
            errorMail($e, $pid);
            return redirect()->back();
        }
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return view('oem.production_data.edit_production_data', compact('productionData', 'id','modelMaster'));
        } catch (\Exception $e) {
            errorMail($e, $pid);
            return redirect()->back();
        }
