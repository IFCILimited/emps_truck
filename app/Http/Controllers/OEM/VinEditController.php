...
class VinEditController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('oem.vin_chassis_edit.vinEdit', compact('vin', 'vinChassis'));
    }
    ...
    public function create($id)
    {
        ...
        if (is_array($vinChassis->vin_chassis)) {
                ...
                if ($vin) {
                    ...
                    if ($existsinProd) {
                        ...
                        if ($existsinBuyerEmps) {
                            ...
                            return redirect()->route('editVin.index');
            ...
            return view('oem.vin_chassis_edit.vinCheck', compact('vin', 'openVins', 'vinChassisData', 'vinChassis'));
