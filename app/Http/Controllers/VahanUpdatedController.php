...
class VahanUpdatedController extends Controller
{
    public function getModelCount($fromDate, $toDate)
    {
        ...
        // $fuelTypes = ["PURE EV"];
        // $oemDetails = ['ATUL AUTO LTD', 'ATHER ENERGY PVT LTD'];
            ...
            foreach($fuelTypes as $fuel) {
                ...
                try {
                    ...
                    curl_setopt_array($ch1, array(
                        ...
                        // CURLOPT_URL => 'https://staging.parivahan.gov.in/vahanModelCountWS/v1.0/getUnapprovedModelCount',
