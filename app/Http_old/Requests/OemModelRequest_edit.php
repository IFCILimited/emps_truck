...
class OemModelRequest_edit extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'vehicle_img' => 'sometimes|file|mimes:jpeg,jpg,png|max:2048',
    ...
    public function messages()
    {
        return [
            ...
            // 'warranty_period.string' => 'The warranty period field must be a string.',
